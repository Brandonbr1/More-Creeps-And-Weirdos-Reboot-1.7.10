...
public class CREEPSWorldGenPyramid extends WorldGenerator {
  ...
  public boolean generate(World world, Random random, int i, int j, int k) {
    ...
    if (world.blockExists(i, j, k)
        && world.blockExists(i + 35, j, k)
        && world.blockExists(i, j, k + 35)
        && world.blockExists(i + 35, j, k + 35)) {
      chunky = true;
    }
    ...
    if (sandy && chunky && l < maxObstruct) {
      ...
      for (int j8 = 1; j8 < tileentitychest.getSizeInventory(); j8++) {
        ...
        if (k8 == 0) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(MoreCreepsAndWeirdos.goodonut, rand.nextInt(15) + 1, 0));
        }

        if (k8 == 1) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(MoreCreepsAndWeirdos.bandaid, rand.nextInt(15) + 1, 0));
        }

        if (k8 == 2) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(MoreCreepsAndWeirdos.raygun, 1, 0));
        }

        if (k8 == 3) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(MoreCreepsAndWeirdos.money, rand.nextInt(15) + 1, 0));
        }

        if (k8 == 4) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(MoreCreepsAndWeirdos.blorpcola, rand.nextInt(10) + 5, 0));
        }
        ...
        if (k8 == 7) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(Items.gold_ingot, rand.nextInt(3) + 2, 0));
        }

        if (k8 == 8) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(Items.iron_ingot, rand.nextInt(5) + 2, 0));
        }

        if (k8 == 9) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(Items.gunpowder, rand.nextInt(4) + 2, 0));
        }

        if (k8 == 10) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(Items.egg, rand.nextInt(3) + 1, 0));
        }

        if (k8 == 11) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(Items.wheat, rand.nextInt(12) + 2, 0));
        }

        if (k8 == 12) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(MoreCreepsAndWeirdos.evilegg, rand.nextInt(15) + 1, 0));
        }

        if (k8 == 13) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(Items.diamond, rand.nextInt(2) + 1, 0));
        }
        ...
        if (k8 == 17) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(Items.arrow, rand.nextInt(30) + 10, 0));
        }
        ...
        if (k8 == 20) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(Items.reeds, rand.nextInt(6) + 6, 0));
        }

        if (k8 == 21) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(Items.paper, rand.nextInt(16) + 6, 0));
        }
        ...
        if (k8 == 23) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(Items.cookie, rand.nextInt(6) + 6, 0));
        }

        if (k8 == 24) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(Items.cake, rand.nextInt(6) + 6, 0));
        }

        if (k8 == 25) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(Items.bucket, rand.nextInt(6) + 6, 0));
        }

        if (k8 == 26) {
          tileentitychest.setInventorySlotContents(
              j8, new ItemStack(MoreCreepsAndWeirdos.evilegg, rand.nextInt(40) + 1, 0));
        }
      ...
      CREEPSEntityPyramidGuardian creepsentitypyramidguardian =
          new CREEPSEntityPyramidGuardian(world);
      creepsentitypyramidguardian.setLocationAndAngles(
          (i + rows) - 2, j - 1, (k + columns) - 3, 300F, 0.0F);

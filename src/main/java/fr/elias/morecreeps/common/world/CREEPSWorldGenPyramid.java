...
public class CREEPSWorldGenPyramid extends WorldGenerator {
    ...
    public boolean generate(World world, Random random, int i, int j, int k) {
        ...
        if (world.blockExists(i, j, k) && world.blockExists(i + 35, j, k)
                ...
                if (maze[j5][l7] == wallCode) {
                    ...
                    if (i8 == 0) {
                        tileentitymobspawner.func_145881_a()
                            .setEntityName("BlackSoul");
                    }

                    if (i8 == 1) {
                        tileentitymobspawner.func_145881_a()
                            .setEntityName("BabyMummy");
                    }
            ...
            for (int j8 = 1; j8 < tileentitychest.getSizeInventory(); j8++) {
                ...
                if (k8 == 0) {
                    tileentitychest.setInventorySlotContents(
                        j8,
                        new ItemStack(MoreCreepsAndWeirdos.goodonut, rand.nextInt(15) + 1, 0));
                }

                if (k8 == 1) {
                    tileentitychest.setInventorySlotContents(
                        j8,
                        new ItemStack(MoreCreepsAndWeirdos.bandaid, rand.nextInt(15) + 1, 0));
                }
                ...
                if (k8 == 3) {
                    tileentitychest.setInventorySlotContents(
                        j8,
                        new ItemStack(MoreCreepsAndWeirdos.money, rand.nextInt(15) + 1, 0));
                }

                if (k8 == 4) {
                    tileentitychest.setInventorySlotContents(
                        j8,
                        new ItemStack(MoreCreepsAndWeirdos.blorpcola, rand.nextInt(10) + 5, 0));
                }
                ...
                if (k8 == 7) {
                    tileentitychest
                        .setInventorySlotContents(j8, new ItemStack(Items.gold_ingot, rand.nextInt(3) + 2, 0));
                }

                if (k8 == 8) {
                    tileentitychest
                        .setInventorySlotContents(j8, new ItemStack(Items.iron_ingot, rand.nextInt(5) + 2, 0));
                }

                if (k8 == 9) {
                    tileentitychest
                        .setInventorySlotContents(j8, new ItemStack(Items.gunpowder, rand.nextInt(4) + 2, 0));
                }
                ...
                if (k8 == 12) {
                    tileentitychest.setInventorySlotContents(
                        j8,
                        new ItemStack(MoreCreepsAndWeirdos.evilegg, rand.nextInt(15) + 1, 0));
                }
                ...
                if (k8 == 26) {
                    tileentitychest.setInventorySlotContents(
                        j8,
                        new ItemStack(MoreCreepsAndWeirdos.evilegg, rand.nextInt(40) + 1, 0));
                }

...
public class CREEPSItemMiningGem extends Item {
    ...
    public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer) {
        ...
        double d3 = (entityplayer.prevPosY + (entityplayer.posY - entityplayer.prevPosY) * (double) f
            + 1.6200000000000001D) - (double) entityplayer.getYOffset();
            ...
            if (l == Blocks.stone || l == Blocks.cobblestone || l == Blocks.mossy_cobblestone || l == Blocks.gravel) {
                ...
                for (int i1 = 0; i1 < 20; i1++) {
                    ...
                    world.spawnParticle(
                        ...
                        (double) ((float) j + 0.5F) + (double) (random.nextFloat() * 2.5F),
                        (double) k + (double) (random.nextFloat() * 1.5F),
                        d1,
                        d4,
                        d7);
                }

        ...
        for (int k = -2; k < 4; k++) {
            for (int l = -3; l < 3; l++) {
                for (int i1 = -3; i1 < 3; i1++) {
                    Block i = world.getBlock(
                        (int) (entityplayer.posX + (double) l),
                        (int) ((entityplayer.posY - 2D) + (double) k),
                        (int) (entityplayer.posZ + (double) i1));
                    Block j = world.getBlock(
                        (int) (entityplayer.posX + (double) l),
                        (int) ((entityplayer.posY - 1.0D) + (double) k),
                        (int) (entityplayer.posZ + (double) i1));
                    ...
                    if ((i == Blocks.dirt || i == Blocks.grass) && random.nextInt(5) == 0 && j == Blocks.air) {
                        ...
                        world.setBlock(
                            ...
                            (int) ((entityplayer.posY - 1.0D) + (double) k),
                            (int) (entityplayer.posZ + (double) i1),
                            Block.getBlockById(59));
                    }

                    int k1 = world.getBlockMetadata(
                        (int) (entityplayer.posX + (double) l),
                        (int) ((entityplayer.posY - 1.0D) + (double) k),
                        (int) (entityplayer.posZ + (double) i1));

...
public class CREEPSItemSpawner extends ItemMonsterPlacer {
  ...
  public int getColorFromItemStack(ItemStack p_82790_1_, int p_82790_2_) {
    CREEPSList.EntityEggInfo entityegginfo =
        CREEPSList.entityEggs.get(Integer.valueOf(p_82790_1_.getItemDamage()));
  ...
  public boolean onItemUse(
    ...
    if (p_77648_3_.isRemote) return true;
      ...
      if (entity != null) {
        ...
        /** if (!p_77648_2_.capabilities.isCreativeMode) { --p_77648_1_.stackSize; } */
      }
        ...
        if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
          ...
          if (p_77659_2_.getBlock(i, j, k) instanceof BlockLiquid) {
            ...
            if (entity != null) {
              ...
              /** if (!p_77659_3_.capabilities.isCreativeMode) { --p_77659_1_.stackSize; } */
            }
          }
        }
  ...
  public static Entity spawnCreature(
      World p_77840_0_, int p_77840_1_, double p_77840_2_, double p_77840_4_, double p_77840_6_) {
    if (!CREEPSList.entityEggs.containsKey(Integer.valueOf(p_77840_1_))) return null;
    else {
      Entity entity = null;

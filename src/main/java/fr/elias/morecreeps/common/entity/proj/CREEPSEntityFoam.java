        ...
        if (movingobjectposition != null) {
            if (movingobjectposition.entityHit != null) {
                if (movingobjectposition.entityHit instanceof EntityLivingBase) {
                    ...
                    movingobjectposition.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, entity), 0);
                ...
                for (int l = -2; l < 2; l++) {
                    for (int i1 = -2; i1 < 2; i1++) {
                        for (int j1 = -2; j1 < 2; j1++) {
                            if (this.worldObj.getBlock(this.hitX + l, this.hitY + j1, this.hitZ + i1) == Blocks.fire) {

...
public class CREEPSEntityFoam extends Entity implements IProjectile {
            ...
            if (movingobjectposition.entityHit != null) {
                if (movingobjectposition.entityHit instanceof EntityLivingBase) {
                    ...
                    movingobjectposition.entityHit
                        .attackEntityFrom(DamageSource.causeThrownDamage(this, (EntityLivingBase) entity), 0);
    ...
    public static DamageSource causeFoamDamage(CREEPSEntityFoam creepsentityfoam, Entity entity) {
        return (new EntityDamageSourceIndirect("foam", creepsentityfoam, entity)).setFireDamage()
            .setProjectile();
    }

    public void blast() {
        if (worldObj.isRemote) MoreCreepsAndWeirdos.proxy.smoke2(worldObj, this, rand);
    }

    public void splash() {
        if (worldObj.isRemote) MoreCreepsAndWeirdos.proxy.blood(worldObj, posX, posY, posZ, true);
    }

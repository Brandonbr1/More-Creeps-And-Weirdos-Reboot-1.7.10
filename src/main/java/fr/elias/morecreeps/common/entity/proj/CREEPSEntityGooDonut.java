...
public class CREEPSEntityGooDonut extends EntityThrowable
{
    ...
    public CREEPSEntityGooDonut(World world, Entity entity) {
        ...
        this.motionX = 0.69999999999999996D * d * MathHelper.cos((entity.rotationPitch / 180F) * (float) Math.PI);
        this.motionY = -0.80000000000000004D * MathHelper.sin((entity.rotationPitch / 180F) * (float) Math.PI);
        this.motionZ = 0.69999999999999996D * d1 * MathHelper.cos((entity.rotationPitch / 180F) * (float) Math.PI);

...
public class CREEPSEntityCastleCritter extends EntityMob {
  ...
  class AIAttackEntity extends EntityAINearestAttackableTarget {
    ...
    public void updateTask() {
      try {
        float f =
            CREEPSEntityCastleCritter.this.getDistanceToEntity(
                CREEPSEntityCastleCritter.this.getAttackTarget());
        CREEPSEntityCastleCritter.this.attackEntity(
            CREEPSEntityCastleCritter.this.getAttackTarget(), f);

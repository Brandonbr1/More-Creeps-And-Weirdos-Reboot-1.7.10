...
public class CREEPSEntityEvilEgg extends Entity {
  ...
  public CREEPSEntityEvilEgg(World world, Entity entity) {
    ...
    this.motionX =
        1.1000000000000001D * d * MathHelper.cos((entity.rotationPitch / 180F) * (float) Math.PI);
    this.motionY =
        -1.1000000000000001D * MathHelper.sin((entity.rotationPitch / 180F) * (float) Math.PI);
    this.motionZ =
        1.1000000000000001D * d1 * MathHelper.cos((entity.rotationPitch / 180F) * (float) Math.PI);
    this.setPosition(
  ...
  public void onUpdate() {
    ...
    if (this.motionY != d1) {
      if (this.rand.nextInt(40) == 0) {
        CREEPSEntityEvilChicken creepsentityevilchicken1 =
            new CREEPSEntityEvilChicken(this.worldObj);
        creepsentityevilchicken1.setLocationAndAngles(
            this.posX, this.posY, this.posZ, this.rotationYaw, 0.0F);
    ...
    if (this.motionY != d1) {
      if (this.rand.nextInt(40) == 0) {
        CREEPSEntityEvilChicken creepsentityevilchicken2 =
            new CREEPSEntityEvilChicken(this.worldObj);
        creepsentityevilchicken2.setLocationAndAngles(
            this.posX, this.posY, this.posZ, this.rotationYaw, 0.0F);

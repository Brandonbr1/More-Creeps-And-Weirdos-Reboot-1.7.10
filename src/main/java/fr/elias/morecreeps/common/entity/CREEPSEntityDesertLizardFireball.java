...
public class CREEPSEntityDesertLizardFireball extends Entity {
    ...
    public void onUpdate() {
        ...
        if (movingobjectposition != null) {
            if (movingobjectposition.entityHit != null) {
                if (movingobjectposition.entityHit
                    .attackEntityFrom(DamageSource.causeThrownDamage(this, (EntityLiving) entity), 2));
            }
        ...
        for (rotationPitch = (float) ((Math.atan2(motionY, f) * 180D) / Math.PI); rotationPitch - prevRotationPitch

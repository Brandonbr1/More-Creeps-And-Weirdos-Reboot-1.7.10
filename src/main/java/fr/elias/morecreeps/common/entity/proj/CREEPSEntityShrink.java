...
public class CREEPSEntityShrink extends EntityThrowable {
    ...
    public CREEPSEntityShrink(World world, EntityLivingBase entityliving, float f) {
        ...
        this.func_22374_a(this.motionX, this.motionY, this.motionZ, (float) (2.5D + (this.worldObj.rand.nextFloat() - 0.5D)), f1);
    }
    ...
    public void onUpdate() {
        ...
        for (int j = 0; j < list.size(); j++) {
            ...
            if (!entity1.canBeCollidedWith()
                    || (entity1 == this.lightValueOwn || this.lightValueOwn != null && entity1 == this.lightValueOwn.ridingEntity)

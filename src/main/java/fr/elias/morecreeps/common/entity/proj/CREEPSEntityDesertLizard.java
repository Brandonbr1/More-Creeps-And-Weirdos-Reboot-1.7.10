...
public class CREEPSEntityDesertLizard extends EntityMob {
    ...
    static final String lizardTextures[] = { "morecreeps:textures/entity/desertlizard1.png",
            "morecreeps:textures/entity/desertlizard2.png", "morecreeps:textures/entity/desertlizard3.png",
            "morecreeps:textures/entity/desertlizard4.png", "morecreeps:textures/entity/desertlizard5.png" };
    ...
    public boolean getCanSpawnHere() {
        ...
        // return (i1 == Blocks.sand || i1 == Blocks.gravel) && i1 != Blocks.cobblestone && i1 != Blocks.log && i1 !=
        // Blocks.double_stone_slab && i1 != Blocks.stone_slab && i1 != Blocks.planks && i1 != Blocks.wool &&
        // worldObj.getCollidingBoundingBoxes(this, getBoundingBox()).size() == 0 && worldObj.canSeeSky(new BlockPos(i,
    ...
    public void onLivingUpdate() {
        if (this.fireballTime-- < 1) {
            ...
            if (this.targetedEntity != null && this.canEntityBeSeen(this.targetedEntity) && (this.targetedEntity instanceof EntityPlayer)) {
                double d1 = this.targetedEntity.getDistanceSqToEntity(this);

                if (d1 < d * d && d1 > 10D) {
                    double d2 = this.targetedEntity.posX - this.posX;
                    double d3 = (this.targetedEntity.boundingBox.minY + this.targetedEntity.height / 2.0F)
                    ...
                    CREEPSEntityDesertLizardFireball creepsentitydesertlizardfireball = new CREEPSEntityDesertLizardFireball(
                            this.worldObj,
                            this,
                            d2,
                            d3,

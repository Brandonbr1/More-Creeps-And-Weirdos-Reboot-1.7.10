    ...
    public void onUpdate() {
        ...
        if (tamed) {
            ...
            if (chase) {
                ...
                if (Math.abs(frisbeeent.posX - posX) < 1.0D && Math.abs(frisbeeent.posY - posY) < 1.0D
                    && Math.abs(frisbeeent.posZ - posZ) < 1.0D) {
                ...
                motionX = (d / (double) f) * 0.40000000000000002D * 0.50000000192092897D
                    + motionX * 0.18000000098023225D;
                motionZ = (d2 / (double) f) * 0.40000000000000002D * 0.40000000192092894D
            ...
            if (fetch && frisbeeent != null) {
                if (Math.abs(frisbeeent.posX - posX) < 2D && Math.abs(frisbeeent.posY - posY) < 2D
                    && Math.abs(frisbeeent.posZ - posZ) < 2D) {
                    worldObj.playSoundAtEntity(
                        this,
                        "random.pop",
                        0.2F,
                ...
                motionX = (d1 / (double) f1) * 0.40000000000000002D * 0.50000000192092897D
                    + motionX * 0.18000000098023225D;
                motionZ = (d3 / (double) f1) * 0.40000000000000002D * 0.40000000192092894D
                    + motionZ * 0.18000000098023225D;

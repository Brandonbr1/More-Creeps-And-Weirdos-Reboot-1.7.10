...
public class CREEPSEntityBubbleScum extends EntityCreature {
  ...
  protected void attackEntity(Entity entity, float f) {
    ...
    this.motionX =
        (d / f1) * 0.40000000000000002D * 0.16000000192092895D
            + this.motionX * 0.18000000098023225D;
    this.motionZ =
        (d1 / f1) * 0.40000000000000002D * 0.12000000192092895D
  ...
  public double getYOffset() {
    ...
    } else return this.getMountedYOffset();
  }
  ...
  protected String getLivingSound() {
    if (this.ridingEntity == null) {
      if (this.rand.nextInt(1) == 0) return "morecreeps:bubblescum";
      else return null;
    } else return null;
  }

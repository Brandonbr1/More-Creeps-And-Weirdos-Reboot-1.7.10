...
public class CREEPSEntityG extends EntityMob {
    ...
    protected void attackEntity(Entity entity, float f) {
        if (this.onGround) {
            ...
            this.motionZ = (d2 / f1) * 0.40000000000000002D * 0.37000000192092897D
        ...
        if (f < 6D) {
            ...
            this.motionX = (d1 / f2) * 0.40000000000000002D * 0.40000000192092894D
                + this.motionX * 0.18000000098023225D;
            this.motionZ = (d3 / f2) * 0.40000000000000002D * 0.27000000192092893D
                + this.motionZ * 0.18000000098023225D;

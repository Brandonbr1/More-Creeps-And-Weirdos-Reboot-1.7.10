...
public class CREEPSEntityHotdog extends EntityMob {
    ...
    static final String Names[] = { "Pogo", "Spot", "King", "Prince", "Bosco", "Ralph", "Wendy", "Trixie", "Bowser",
        "The Heat", "Weiner", "Wendon the Weiner", "Wallace the Weiner", "William the Weiner", "Terrance", "Elijah",
        "Good Boy", "Boy", "Girl", "Tennis Shoe", "Rusty", "Mean Joe Green", "Lawrence", "Foxy", "SlyFoxHound",
        "Leroy Brown" };
    ...
    static final String dogTextures[] = { "morecreeps:textures/entity/hotdg1.png",
        "morecreeps:textures/entity/hotdg2.png", "morecreeps:textures/entity/hotdg3.png" };
    public static final int leveldamage[] = { 0, 50, 100, 250, 500, 800, 1200, 1700, 2200, 2700, 3300, 3900, 4700, 5400,
        6200, 7000, 7900, 8800, 9750, 10750, 12500, 17500, 22500, 30000, 40000, 50000, 60000 };
    public static final String levelname[] = { "Just A Pup", "Hotdog", "A Dirty Dog", "An Alley Dog", "Scrapyard Puppy",
        "Army Dog", "Private", "Private First Class", "Corporal", "Sergeant", "Staff Sergeant", "Sergeant First Class",
        "Master Segeant", "First Sergeant", "Sergeant Major", "Command Sergeant Major", "Second Lieutenant",
        "First Lieutenant", "Captain", "Major", "Lieutenant Colonel", "Colonel", "General of the Hotdog Army",
        "General of the Hotdog Army", "Sparky the Wonder Pooch", "Sparky the Wonder Pooch" };
    ...
    protected void entityInit() {
        ...
        this.getDataWatcher()
            .addObject(16, ""); // Name
        this.getDataWatcher()
            .addObject(17, (byte) 0); // Tamed flag
        this.getDataWatcher()
            .addObject(18, 1); // Level
        this.getDataWatcher()
    ...
    public void syncDataWatcher() {
        if (!this.worldObj.isRemote) {
            this.getDataWatcher()
                .updateObject(16, this.name != null ? this.name : "");
            this.getDataWatcher()
                .updateObject(17, (byte) (this.tamed ? 1 : 0));
            this.getDataWatcher()
                .updateObject(18, this.level);
            this.getDataWatcher()
                .updateObject(19, this.basetexture != null ? this.basetexture : "");
            this.getDataWatcher()
                .updateObject(20, this.texture != null ? this.texture : "");
        }
    }

    public void updateFromDataWatcher() {
        if (this.worldObj.isRemote) {
            String syncedName = this.getDataWatcher()
                .getWatchableObjectString(16);
            if (syncedName != null && !syncedName.equals(this.name)) {
                this.name = syncedName;
            }

            boolean syncedTamed = this.getDataWatcher()
                .getWatchableObjectByte(17) == 1;
            if (syncedTamed != this.tamed) {
                this.tamed = syncedTamed;
            }

            int syncedLevel = this.getDataWatcher()
                .getWatchableObjectInt(18);
            if (syncedLevel != this.level && syncedLevel > 0) {
                this.level = syncedLevel;
            }

            String syncedBaseTexture = this.getDataWatcher()
                .getWatchableObjectString(19);
            if (syncedBaseTexture != null && !syncedBaseTexture.isEmpty()
            ...
            String syncedTexture = this.getDataWatcher()
                .getWatchableObjectString(20);
            if (syncedTexture != null && !syncedTexture.isEmpty() && !syncedTexture.equals(this.texture)) {
    ...
    protected void updateAITick() {
        ...
        if (this.tamed && this.wanderstate == 0) {
            ...
            List<?> list = this.worldObj
                .getEntitiesWithinAABBExcludingEntity(this, this.boundingBox.expand(16D, 16D, 16D));
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                if (this.rand.nextInt(100) < firechance[this.skillattack] && this.firenum < firenumber[this.skillattack]
                    && this.firepower >= 25) {
                    float f1 = this.getDistanceToEntity(entitycreature);

                    if (f1 < this.skillattack + 1 && this.rand.nextInt(100) < firechance[this.skillattack]
            ...
            if (rider.isSneaking() && !this.isDead && this.worldObj != null) {
                ...
                if (!this.worldObj.isRemote) {
                    MoreCreepsAndWeirdos.proxy
                        .addChatMessage(this.worldObj, "\247b" + this.name + "\247f: See you later!");
                }
            }
        }
    ...
    protected Entity findPlayerToAttack() {
        ...
        if (this.tamed && this.wanderstate == 0 && this.worldObj != null && this.getBoundingBox() != null) {
    ...
    protected void attackEntity(Entity entity, float f) {
        if (this.wanderstate == 0 && !(this.getAttackTarget() instanceof EntityPlayer)
            ...
            if (this.onGround && this.tamed) {
                ...
                this.motionZ = (d2 / f2) * 0.5D * 0.88000001192092892D + this.motionZ * 0.20000000298023224D;
                ...
                if (this.rand.nextInt(100) < d1) {
                    ...
                    ((EntityLiving) entity).attackEntityFrom(DamageSource.causeThrownDamage(this, entity), (int) f1);
    ...
    public void setDead() {
        if (this.interest == 0 || this.health <= 0) {
            if (this.tamed) {
                ...
                creepsentitytombstone.setLocationAndAngles(this.posX, this.posY, this.posZ, this.rotationYaw, 0.0F);
    ...
    public boolean interact(EntityPlayer entityplayer) {
        ...
        if (this.tamed && entityplayer.isSneaking()) {
            if (this.worldObj != null && !this.isDead) {
                MoreCreepsAndWeirdos.guiHandler
                    .tryOpenGui(CREEPSGuiHandler.GuiType.HOTDOG.id, entityplayer, this.worldObj, this.getEntityId());
                return true;
            } else {
                return false;
            }
        ...
        if (itemstack == null && this.tamed && this.health > 0) {
            ...
            if (this.ridingEntity == entityplayer) {
                ...
                if (this.worldObj != null && !this.worldObj.isRemote) {
                    MoreCreepsAndWeirdos.proxy
                        .addChatMessage(this.worldObj, "\247b" + this.name + "\247f: I'll walk from here!");
                }
                ...
                if (this.worldObj != null && !this.worldObj.isRemote) {
                    MoreCreepsAndWeirdos.proxy
                        .addChatMessage(this.worldObj, "\247b" + this.name + "\247f: Carrying me around!");
                }
            } else {
                if (this.worldObj != null && !this.worldObj.isRemote) {
                ...
                if (!this.heavenbuilt) {
                    if (this.level >= 25) {
                        ...
                        this.worldObj.playSoundAtEntity(
                            ...
                            (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F + 1.0F);
                        MoreCreepsAndWeirdos.proxy
                            .addChatMessage(this.worldObj, "Your Hotdog must be level 25 to build Hot Dog Heaven.");
                        MoreCreepsAndWeirdos.proxy.addChatMessage(
                            this.worldObj,
                            (new StringBuilder()).append("\247b")
                                .append(this.name)
    ...
    public void buildHeaven(EntityPlayer entityplayer, int i, int j, int k) {
        if (j > 95) {
            MoreCreepsAndWeirdos.proxy.addChatMessage(this.worldObj, "You are too far up to build Hotdog Heaven!");
            return;
        }
        ...
        if (this.worldObj.blockExists(i - byte0 / 2, j, k - byte1 / 2) && this.worldObj.blockExists(i + byte0, j, k)
        ...
        if (i1 < 3000 && this.chunky) {
                ...
                for (int i6 = 0; i6 < byte1; i6++) {
                    for (int k7 = 0 - this.rand.nextInt(3) - 2; k7 < 1; k7++) {
                        if (k7 < 0) {
                            ...
                            this.worldObj
                                .setBlock((i + j2) - byte0 / 2, (j + l * 2 + k7) - 2, ((k + i6) - byte1), Blocks.dirt);
                        } else {
                            // worldObj.setBlockWithNotify((i + j2) - byte0 / 2, (j + l * 2 + k7) - 2, ((k + i6) -
            ...
            for (int j3 = 0; j3 < this.rand.nextInt(30) + 2; j3++) {
                ...
                if (Block.getIdFromBlock(
                    this.worldObj.getBlock((i + j6) - byte0 / 2, (j + l * 2) - 1, (k + l7) - byte1)) == 0) {
                    // worldObj.setBlockWithNotify((i + j6) - byte0 / 2, (j + l * 2) - 1, (k + l7) - byte1,
                    // 31);
                    this.worldObj.setBlock((i + j6) - byte0 / 2, (j + l * 2) - 1, (k + l7) - byte1, Blocks.deadbush);
                    // worldObj.setBlockMetadataWithNotify((i + j6) - byte0 / 2, (j + l * 2) - 1, (k + l7) -
                    // byte1, 2);
                    this.worldObj.setBlock((i + j6) - byte0 / 2, (j + l * 2) - 1, (k + l7) - byte1, Blocks.grass);
                }
            }
            ...
            for (int k3 = 0; k3 < this.rand.nextInt(50) + 2; k3++) {
                ...
                if (Block.getIdFromBlock(
                    this.worldObj.getBlock((i + k6) - byte0 / 2, (j + l * 2) - 1, (k + i8) - byte1)) == 0) {
                    // worldObj.setBlockWithNotify((i + k6) - byte0 / 2, (j + l * 2) - 1, (k + i8) - byte1,
                    // 31);
                    this.worldObj.setBlock((i + k6) - byte0 / 2, (j + l * 2) - 1, (k + i8) - byte1, Blocks.deadbush);
                    // worldObj.setBlockMetadataWithNotify((i + k6) - byte0 / 2, (j + l * 2) - 1, (k + i8) -
                    // byte1, 1);
                    this.worldObj.setBlock((i + k6) - byte0 / 2, (j + l * 2) - 1, (k + i8) - byte1, Blocks.stone);
                }
            }
            ...
            for (int l3 = 1; l3 < byte0 - 1; l3++) {
                ...
                // Block.fence.blockID);
                this.worldObj.setBlock((i + l3) - byte0 / 2, (j + l * 2) - 1, (k - byte1) + 3, Blocks.fence);
            ...
            for (int i4 = 4; i4 < byte1; i4++) {
                ...
                // Block.fence.blockID);
                this.worldObj.setBlock((i - byte0 / 2) + 1, (j + l * 2) - 1, (k + i4) - byte1, Blocks.fence);
                // worldObj.setBlockWithNotify((i + byte0) - byte0 / 2 - 2, (j + l * 2) - 1, (k + i4) -
                // byte1,
                // Block.fence.blockID);
                this.worldObj.setBlock((i + byte0) - byte0 / 2 - 2, (j + l * 2) - 1, (k + i4) - byte1, Blocks.fence);
                flag = !flag;
                ...
                if (flag) {
                    ...
                    // Block.torchWood.blockID);
                    this.worldObj.setBlock((i + byte0) - byte0 / 2 - 2, j + l * 2, (k + i4) - byte1, Blocks.torch);
                }
            }
            ...
            for (int k4 = 0; k4 < this.rand.nextInt(15) + 5; k4++) {
                ...
                this.worldObj.setBlock((i + l6) - byte0 / 2, (j + l * 2) - 1, (k + j8) - byte1, Blocks.sapling);
                // TODO Below may not grow the tree (I think), but there seems to be no other way :(
                ((BlockSapling) Blocks.sapling)
                    .func_149879_c(this.worldObj, (i + l6) - byte0 / 2, (j + l * 2) - 1, (k + j8) - byte1, this.rand);
            }

            for (int l4 = (byte0 / 2 + this.rand.nextInt(8)) - 8; l4
                < ((byte0 / 2 + this.rand.nextInt(10)) - 5) + 8; l4++) {
                for (int i7 = (byte1 / 2 + this.rand.nextInt(8)) - 8; i7
                    < ((byte1 / 2 + this.rand.nextInt(10)) - 5) + 8; i7++) {
                    // worldObj.setBlockWithNotify((i + l4) - byte0 / 2, (j + l * 2) - 2, (k + i7) - byte1,
                    // Block.waterStill.blockID);
                    this.worldObj.setBlock((i + l4) - byte0 / 2, (j + l * 2) - 2, (k + i7) - byte1, Blocks.water);
                    // worldObj.setBlockWithNotify((i + l4) - byte0 / 2, (j + l * 2) - 3, (k + i7) - byte1,
                    // Block.waterStill.blockID);
                    this.worldObj.setBlock((i + l4) - byte0 / 2, (j + l * 2) - 3, (k + i7) - byte1, Blocks.water);
                }
            }
            ...
            MoreCreepsAndWeirdos.proxy
                .addChatMessage(this.worldObj, "Hotdog Heaven cannot be built here, choose another spot!");
        }
    }

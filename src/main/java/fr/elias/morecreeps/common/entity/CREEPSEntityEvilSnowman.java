...
public class CREEPSEntityEvilSnowman extends EntityMob {
    ...
    public void onDeath(DamageSource damagesource) {
        ...
        if (!((EntityPlayerMP) entityplayer).func_147099_x()
            .hasAchievementUnlocked(MoreCreepsAndWeirdos.achievesnowtiny) && snowsize < 0.1F) {
        ...
        if (!((EntityPlayerMP) entityplayer).func_147099_x()
            .hasAchievementUnlocked(MoreCreepsAndWeirdos.achievesnowtall) && snowsize > 5F) {
            worldObj.playSoundAtEntity(entityplayer, "morecreeps:achievement", 1.0F, 1.0F);
    ...
    public void playLivingSound() {
        ...
        if (s != null) {
            worldObj.playSoundAtEntity(
                ...
                s,
                getSoundVolume(),
                (rand.nextFloat() - rand.nextFloat()) * 0.2F + 1.0F + (1.0F - snowsize) * 2.0F);
        }
    }

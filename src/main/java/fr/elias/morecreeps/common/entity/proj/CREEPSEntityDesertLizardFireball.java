    ...
    public void onUpdate() {
        ...
        if (movingobjectposition != null) {
            if (movingobjectposition.entityHit != null) {
                if (movingobjectposition.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, entity), 2)) {
                    ;
                }
            }
        ...
        for (this.rotationPitch = (float) ((Math.atan2(this.motionY, f) * 180D) / Math.PI); this.rotationPitch

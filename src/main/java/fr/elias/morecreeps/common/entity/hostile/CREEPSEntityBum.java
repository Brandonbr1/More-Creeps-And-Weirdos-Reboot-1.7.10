...
public class CREEPSEntityBum extends EntityMob {
        ...
        if (this.timetopee-- < 0 && !this.bumgave && CREEPSConfig.publicUrination) {
            ...
            if (this.worldObj.isRemote) {
                MoreCreepsAndWeirdos.proxy
                    .pee(this.worldObj, this.posX, this.posY, this.posZ, this.rotationYaw, this.modelsize);
            }
                        ...
                        if (this.rand.nextInt(4) == 0) {
                            for (int l1 = 0; l1 < this.rand.nextInt(3) + 1; l1++) {
                                Blocks.obsidian.dropBlockAsItem(
                                    ...
                                    j1,
                                    k1,
                                    this.worldObj.getBlockMetadata(l, j1, k1),
                                    0);
                            }
                        }
    ...
    protected String getLivingSound() {
        if (this.timetopee > 0 || this.bumgave || !CREEPSConfig.publicUrination) return "morecreeps:bum";

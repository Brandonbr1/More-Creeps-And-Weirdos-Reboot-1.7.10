...
public class CREEPSEntityBum extends EntityMob {
    ...
    public CREEPSEntityBum(World world) {
        ...
        this.texture = new ResourceLocation(Reference.MOD_ID, Reference.TEXTURE_PATH_ENTITES + Reference.TEXTURE_BUM);
        this.angerLevel = 0;
    ...
    public String pingText() {
        return (new StringBuilder()).append("angerLevel ")
                .append(this.angerLevel)
                .toString();
    }
    ...
    public void onLivingUpdate() {
        ...
        if (this.timetopee-- < 0 && !this.bumgave && CREEPSConfig.publicUrination) {
            ...
            if (this.worldObj.isRemote) {
                MoreCreepsAndWeirdos.proxy.pee(this.worldObj, this.posX, this.posY, this.posZ, this.rotationYaw, this.modelsize);
            }
    ...
    public boolean interact(EntityPlayer entityplayer) {
        ...
        if (!this.bumgave && this.angerLevel == 0) {
            if (itemstack != null && (itemstack.getItem() == Items.diamond || itemstack.getItem() == Items.gold_ingot
                ...
                if (this.timetopee > 0) {
                    this.worldObj.playSoundAtEntity(
                            ...
                            1.0F,
                            (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F + 1.0F);
                } else if (itemstack != null && (itemstack.getItem() == Item.getItemFromBlock(Blocks.yellow_flower)
                    ...
                    if (this.rand.nextInt(4) == 0) {
                        for (int l1 = 0; l1 < this.rand.nextInt(3) + 1; l1++) {
                            Blocks.obsidian
                            .dropBlockAsItem(this.worldObj, l, j1, k1, this.worldObj.getBlockMetadata(l, j1, k1), 0);
                        }
                    }

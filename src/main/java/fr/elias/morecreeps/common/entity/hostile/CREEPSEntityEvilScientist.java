...
public class CREEPSEntityEvilScientist extends EntityMob {
    ...
    public void onLivingUpdate() {
        ...
        if (this.stage == 1 && this.onGround && this.experimentstart && this.posY > 63D) {
            ...
            if (this.posY > 63D && this.area == Blocks.air
                ...
                this.worldObj.setBlock(this.towerX + 2, this.towerY + this.towerHeight, this.towerZ + 2, Blocks.crafting_table);
        ...
        if (this.stage == 3) {
            ...
            if (this.rand.nextInt(150) == 0 && !this.water) {
                this.worldObj.setBlock(this.towerX + 2, this.towerY + this.towerHeight, this.towerZ + 1, Blocks.flowing_water);
                this.worldObj.setBlock(this.towerX + 3, this.towerY + this.towerHeight, this.towerZ + 2, Blocks.flowing_water);
                this.worldObj.setBlock(this.towerX + 1, this.towerY + this.towerHeight, this.towerZ + 2, Blocks.flowing_water);
                this.worldObj.setBlock(this.towerX + 2, this.towerY + this.towerHeight, this.towerZ + 3, Blocks.flowing_water);
                this.water = true;
            }

            if (this.rand.nextInt(8) == 0) {
                CREEPSEntityEvilLight creepsentityevillight = new CREEPSEntityEvilLight(this.worldObj);
                creepsentityevillight.setLocationAndAngles(this.towerX, this.towerY + this.towerHeight, this.towerZ, this.rotationYaw, 0.0F);
            ...
            if (!this.experimentstart) {
                ...
                .setLocationAndAngles(this.towerX, this.towerY + this.towerHeight + 10, this.towerZ, this.rotationYaw, 0.0F);
                this.worldObj.spawnEntityInWorld(creepsentityevillight1);
                this.experimentstart = true;
            }

            if (this.experimenttimer == 0) {
                this.worldObj.createExplosion(null, this.towerX + 2, this.towerY + this.towerHeight + 4, this.towerZ + 2, 2.0F, true);
                this.experimentstart = false;
                this.stage = 4;
            }
        }
        ...
        if (this.stage == 4) {
            ...
            for (int i5 = 0; i5 < this.rand.nextInt(5) + 1; i5++) {
                this.worldObj.addWeatherEffect(
                        new EntityLightningBolt(this.worldObj, (l1 + this.rand.nextInt(4)) - 2, k3 + 6, (l4 + this.rand.nextInt(4)) - 2));
            }
            ...
            for (int j5 = 0; j5 < this.rand.nextInt(4) + 1; j5++) {
                ...
                if (k5 == 1) {
                    ...
                    .setLocationAndAngles(this.towerX, this.towerY + this.towerHeight + 1, this.towerZ, this.rotationYaw, 0.0F);
                    ...
                    for (int k = 0; k < 3; k++) {
                        for (int l = 0; l < 4; l++) {
                            for (int i1 = 0; i1 < 10; i1++) {
                                ...
                                this.worldObj.spawnParticle(
                                        "largesmoke",
                                        ((double) (2.0F + this.towerX) + (double) (this.rand.nextFloat() * this.width * 2.0F))
                                        - this.width,
    ...
    class AITargetingSystem extends EntityAIBase {
        ...
        public boolean shouldExecute() {
            ...
            return CREEPSEntityEvilScientist.this.trulyevil && entitylivingbase != null && entitylivingbase.isEntityAlive();
        }

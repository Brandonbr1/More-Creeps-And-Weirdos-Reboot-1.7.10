...
public class CREEPSEntityEvilScientist extends EntityMob {
  ...
  public CREEPSEntityEvilScientist(World world) {
    ...
    if (this.trulyevil) {
      this.targetTasks.addTask(
          2, new EntityAINearestAttackableTarget(this, EntityPlayer.class, 1, true));
    }
  }
  ...
  public void onLivingUpdate() {
    ...
    if (this.stage == 1 && this.onGround && this.experimentstart && this.posY > 63D) {
      ...
      for (int i = 0; i < this.towerHeight; i++) {
        for (int i2 = 0; i2 < 3; i2++) {
          for (int l3 = 0; l3 < 3; l3++) {
            this.area =
                this.worldObj.getBlock(this.towerX + l3, this.towerY + i, this.towerZ + i2 + 1);
            this.area =
                this.worldObj.getBlock(this.towerX + i2 + 1, this.towerY + i, this.towerZ + l3);
          }
        }
      }
      ...
      if (this.posY > 63D
          ...
          && this.worldObj.getBlock(this.towerX + 2, this.towerY - 1, this.towerZ + 2)
              != Blocks.water
          && this.worldObj.getBlock(this.towerX + 2, this.towerY - 1, this.towerZ + 2)
          ...
          for (int j2 = 0; j2 < 3; j2++) {
            for (int i4 = 0; i4 < 3; i4++) {
              ...
              this.worldObj.setBlock(
                  this.towerX + i4, this.towerY + j, this.towerZ + j2 + 1, byte0);
              ...
              this.worldObj.setBlock(
                  this.towerX + j2 + 1, this.towerY + j, this.towerZ + i4, byte0);
            }
          }
        }
        ...
        for (int k = 0; k < this.towerHeight; k++) {
           ...
           */
          Blocks.ladder.onBlockPlaced(
              this.worldObj, this.towerX, this.towerY + k, this.towerZ, 0, 0, 0, 0, 0);
        }
    ...
    if (this.stage == 3) {
      ...
      if (this.rand.nextInt(150) == 0 && !this.water) {
        this.worldObj.setBlock(
            this.towerX + 2, this.towerY + this.towerHeight, this.towerZ + 1, Blocks.flowing_water);
        this.worldObj.setBlock(
            this.towerX + 3, this.towerY + this.towerHeight, this.towerZ + 2, Blocks.flowing_water);
        this.worldObj.setBlock(
            this.towerX + 1, this.towerY + this.towerHeight, this.towerZ + 2, Blocks.flowing_water);
        this.worldObj.setBlock(
            this.towerX + 2, this.towerY + this.towerHeight, this.towerZ + 3, Blocks.flowing_water);
        this.water = true;
      }
      ...
      if (this.rand.nextInt(8) == 0) {
        ...
        creepsentityevillight.setLocationAndAngles(
            this.towerX, this.towerY + this.towerHeight, this.towerZ, this.rotationYaw, 0.0F);
        ...
        for (int j1 = 0; j1 < 4; j1++) {
          for (int i3 = 0; i3 < 10; i3++) {
            ...
            this.worldObj.spawnParticle(
                "largesmoke",
                ((2.0F + this.towerX) + (double) (this.rand.nextFloat() * this.width * 2.0F))
                    - this.width,
                (1.0F + this.towerY + this.towerHeight)
                    + (double) (this.rand.nextFloat() * this.height)
                    + 2D,
                (2D + (this.towerZ + (double) (this.rand.nextFloat() * this.width * 2.0F)))
                    - this.width,
                d,
                d2,
                d4);
      ...
      if (!this.experimentstart) {
        ...
        creepsentityevillight1.setLocationAndAngles(
            this.towerX, this.towerY + this.towerHeight + 10, this.towerZ, this.rotationYaw, 0.0F);
      ...
      if (this.experimenttimer == 0) {
        this.worldObj.createExplosion(
            null, this.towerX + 2, this.towerY + this.towerHeight + 4, this.towerZ + 2, 2.0F, true);
        this.experimentstart = false;
        this.stage = 4;
      }
    }
      ...
      for (int j5 = 0; j5 < this.rand.nextInt(4) + 1; j5++) {
        ...
        if (k5 == 0) {
          for (int l5 = 0; l5 < this.rand.nextInt(8) + 2; l5++) {
            CREEPSEntityEvilSnowman creepsentityevilsnowman =
                new CREEPSEntityEvilSnowman(this.worldObj);
        ...
        if (k5 == 1) {
          CREEPSEntityEvilScientist creepsentityevilscientist =
              new CREEPSEntityEvilScientist(this.worldObj);
          creepsentityevilscientist.setLocationAndAngles(
              this.towerX, this.towerY + this.towerHeight + 1, this.towerZ, this.rotationYaw, 0.0F);
        ...
        if (k5 == 3) {
          for (int i6 = 0; i6 < this.rand.nextInt(4) + 1; i6++) {
            CREEPSEntityEvilChicken creepsentityevilchicken =
                new CREEPSEntityEvilChicken(this.worldObj);
        ...
        for (int j6 = 0; j6 < this.rand.nextInt(8) + 2; j6++) {
          CREEPSEntityEvilSnowman creepsentityevilsnowman1 =
              new CREEPSEntityEvilSnowman(this.worldObj);
  ...
  class AITargetingSystem extends EntityAIBase {
    ...
    public boolean shouldExecute() {
      ...
      return CREEPSEntityEvilScientist.this.trulyevil

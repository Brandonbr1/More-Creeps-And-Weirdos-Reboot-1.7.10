...
public class CREEPSEntityRocket extends Entity {
  ...
  public CREEPSEntityRocket(World world) {
    ...
    this.hitY = -1;
    this.hitZ = -1;
    // TODO: GREAT QUESTION, PROB THROUGH LOOKING AT THE BUCKET OR BOTTLE CODE.
    // Don't know how to fix; not in 1.7.10
    // blockHit = false;
  ...
  public void onUpdate() {
    ...
    if (this.worldObj.isRemote) {
      MoreCreepsAndWeirdos.proxy.rocketSmoke(
          this.worldObj, this, MoreCreepsAndWeirdos.partWhite); // or partBlack ?
    }
      ...
      if (movingobjectposition.entityHit != null) {
        ...
        if ((movingobjectposition.entityHit instanceof EntityLiving)
          ...
          if (movingobjectposition.entityHit.attackEntityFrom(
              DamageSource.causeThrownDamage(this, entity), this.damage)) {;
          }
  ...
  public void checkSplashDamage() {
    ...
    list =
        this.worldObj.getEntitiesWithinAABBExcludingEntity(
            this, this.getBoundingBox().expand(5D, 5D, 5D));

...
public class CREEPSEntityHippo extends EntityMob {
  ...
  public CREEPSEntityHippo(World world) {
    ...
    this.targetTasks.addTask(
        2, new CREEPSEntityHippo.AIAttackEntity(this, EntityPlayer.class, true));
    this.targetTasks.addTask(2, new CREEPSEntityHippo.AIAttackEntity(this, EntityMob.class, true));
    this.targetTasks.addTask(
        2, new CREEPSEntityHippo.AIAttackEntity(this, EntityAnimal.class, true));
  }
  ...
  class AIAttackEntity extends EntityAINearestAttackableTarget {
    ...
    public boolean shouldExecute() {
      return CREEPSEntityHippo.this.hippoHit
          && CREEPSEntityHippo.this.getAttackTarget() != null
          && super.shouldExecute();
    }
    ...
    public void updateTask() {
      try {
        double d0 =
            CREEPSEntityHippo.this.getDistanceSqToEntity(CREEPSEntityHippo.this.getAttackTarget());
        if (d0 < 256D) {

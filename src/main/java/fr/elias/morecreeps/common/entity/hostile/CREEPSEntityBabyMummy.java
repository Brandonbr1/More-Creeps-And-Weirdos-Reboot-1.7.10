...
public class CREEPSEntityBabyMummy extends EntityMob {
  ...
  static final ResourceLocation mummyTextures[] = {
    new ResourceLocation(
        Reference.MOD_ID, Reference.TEXTURE_PATH_ENTITES + Reference.TEXTURE_MUMMY1),
    new ResourceLocation(
        Reference.MOD_ID, Reference.TEXTURE_PATH_ENTITES + Reference.TEXTURE_MUMMY2),
    new ResourceLocation(
        Reference.MOD_ID, Reference.TEXTURE_PATH_ENTITES + Reference.TEXTURE_MUMMY3)
  };
  ...
  public boolean getCanSpawnHere() {
    ...
    // return (i1 == Blocks.sand || i1 == Blocks.bedrock) && i1 != Blocks.cobblestone && i1 !=
    // Blocks.log && i1 !=
    // Blocks.planks && i1 != Blocks.wool && worldObj.getCollidingBoundingBoxes(this,
    // getBoundingBox()).size() == 0
    ...
    if (f > 2.0F && f < 6F && this.rand.nextInt(10) == 0) {
      if (this.onGround) {
        ...
        if (this.worldObj.getBlock(i, j - 2, k) == Blocks.sand) {
          ...
          this.motionX =
              (d / f2) * 0.5D * 0.8000000019209289D + this.motionX * 0.18000000098023225D;
          this.motionZ =
              (d1 / f2) * 0.5D * 0.70000000192092893D + this.motionZ * 0.18000000098023225D;
        }
      }
    }
  }

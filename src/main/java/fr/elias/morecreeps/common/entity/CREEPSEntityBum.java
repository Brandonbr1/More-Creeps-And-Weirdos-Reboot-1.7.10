...
public class CREEPSEntityBum extends EntityMob {
    ...
    public CREEPSEntityBum(World world) {
        ...
        texture = new ResourceLocation(Reference.MOD_ID, Reference.TEXTURE_PATH_ENTITES + Reference.TEXTURE_BUM);
        angerLevel = 0;
        attackRange = 16D;
        bumgave = false;
                    ...
                    || itemstack.getItem() == Item.getItemFromBlock(Blocks.red_flower))) {
                        ...
                        if (rand.nextInt(4) == 0) {
                            for (int l1 = 0; l1 < rand.nextInt(3) + 1; l1++) {
                                Blocks.obsidian
                                    .dropBlockAsItem(worldObj, l, j1, k1, worldObj.getBlockMetadata(l, j1, k1), 0);
                            }
                        }

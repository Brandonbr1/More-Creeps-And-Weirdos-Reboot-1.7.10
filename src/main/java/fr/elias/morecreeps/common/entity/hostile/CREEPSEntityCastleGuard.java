...
public class CREEPSEntityCastleGuard extends EntityMob {
  ...
  static final String guardTextures[] = {
    "/textures/entity/castleguard1.png",
    "/textures/entity/castleguard2.png",
    "/textures/entity/castleguard3.png",
    "/textures/entity/castleguard4.png",
    "/textures/entity/castleguard5.png"
  };
  ...
  public boolean getCanSpawnHere() {
    ...
    return this.worldObj.difficultySetting.getDifficultyId() > 0
        && this.worldObj.checkNoEntityCollision(this.getBoundingBox())
        && this.worldObj.getCollidingBoundingBoxes(this, x).size() == 0;
  }
  ...
  protected String getLivingSound() {
    if (this.attacked && this.rand.nextInt(5) == 0) return "morecreeps:castleguardmad";

    if (this.rand.nextInt(12) == 0) return "morecreeps:castleguard";
    else return null;
  }

...
public class CREEPSEntityTombstone extends EntityAnimal {
  ...
  public boolean interact(EntityPlayer entityplayer) {
    ...
    if (itemstack != null && itemstack.getItem() == MoreCreepsAndWeirdos.lifegem) {
      ...
      if (this.deathtype.equals("GuineaPig")) {
        ...
        creepsentityguineapig.setLocationAndAngles(
        ...
        if (this.wanderstate == 1) {
          ...
          creepsentityguineapig.moveSpeed =
              this.speedboost <= 0 ? this.baseSpeed : this.baseSpeed + 0.5F;
        }
      ...
      if (this.deathtype.equals("Hotdog")) {
        ...
        creepsentityhotdog.setLocationAndAngles(
            this.posX, this.posY, this.posZ, this.rotationYaw, 0.0F);
  ...
  protected String getLivingSound() {
    if (this.rand.nextInt(10) == 0) return "morecreeps:tombstone";
    else return null;
  }

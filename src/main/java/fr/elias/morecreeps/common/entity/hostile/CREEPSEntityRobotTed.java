...
public class CREEPSEntityRobotTed extends EntityMob {
    ...
    public CREEPSEntityRobotTed(World world) {
        ...
        this.targetTasks.addTask(
                2, new EntityAINearestAttackableTarget(this, CREEPSEntityRobotTodd.class, 0, true));
    }
    ...
    public void onLivingUpdate() {
        ...
        if (this.worldObj.isRemote) {
            MoreCreepsAndWeirdos.proxy.robotTedSmoke(
                    this.worldObj, this.posX, this.posY, this.posZ, this.floattimer, this.modelspeed);
        }
    }
    ...
    protected void attackEntity(Entity entity, float f) {
        ...
        if (this.attackTime <= 0 && f < (double)(3.1F - (2.5F - this.robotsize)) && entity.boundingBox.maxY > this.boundingBox.minY && entity.boundingBox.minY < this.boundingBox.maxY)
        {
            this.attackTime = 20;

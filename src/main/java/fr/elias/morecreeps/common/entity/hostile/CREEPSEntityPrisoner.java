    ...
    public void onLivingUpdate() {
        if (this.inWater) {
            ...
            if (entityplayersp != null) {
                ...
                if (f < 3F && this.canEntityBeSeen(entityplayersp)
                    && !this.saved
                    && this.timeonland++ > 50
                    && !this.evil) {
    ...
    public void giveReward(EntityPlayer player) {
        ...
        if (player != null && !this.worldObj.isRemote) {
            ...
            switch (i) {
                ...
                case 4:
                    entityitem = this
                        .entityDropItem(new ItemStack(MoreCreepsAndWeirdos.money, this.rand.nextInt(20) + 1, 0), 1.0F);
                    break;

                default:
                    entityitem = this
                        .entityDropItem(new ItemStack(MoreCreepsAndWeirdos.money, this.rand.nextInt(5) + 1, 0), 1.0F);
                    break;
            }

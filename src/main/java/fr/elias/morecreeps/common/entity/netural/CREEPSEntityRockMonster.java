...
public class CREEPSEntityRockMonster extends EntityMob {
    ...
    public class AIAttackEntity extends EntityAIBase {
        ...
        public boolean shouldExecute() {
            ...
            return entitylivingbase != null && entitylivingbase.isEntityAlive()
                && CREEPSEntityRockMonster.this.angerLevel > 0;
        }
     ...
     * damagesource.getEntity(); if (worldObj == null) { return
     * super.attackEntityFrom(DamageSource.causeMobDamage(this), i); } if (entity instanceof
     * EntityPlayer) { List list = worldObj.getEntitiesWithinAABBExcludingEntity(this,
     * getBoundingBox().expand(32D, 32D, 32D)); for (Object o : list) { if (o instanceof Entity) {
     * Entity entity1 = (Entity) o; if (entity1 instanceof CREEPSEntityRockMonster) {
     * CREEPSEntityRockMonster creepsentityrockmonster = (CREEPSEntityRockMonster) entity1;
     * creepsentityrockmonster.becomeAngryAt(entity); } } } becomeAngryAt(entity); } return

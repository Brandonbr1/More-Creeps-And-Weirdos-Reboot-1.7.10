...
public class CREEPSEntityBlorp extends EntityAnimal {
  ...
  private void playBlorpEatSound() {
    worldObj.playSoundAtEntity(
        this, "morecreeps:blorpeat", 1.0F, (rand.nextFloat() - rand.nextFloat()) * 0.2F + 1.0F);
  }
  ...
  public void attackEntity(Entity entity, float f) {
    if (onGround) {
      ...
      motionX =
          (d / f1) * 0.20000000000000001D * 0.80000001192092896D + motionX * 0.20000000298023224D;
      motionZ =
          (d2 / f1) * 0.20000000000000001D * 0.80000001192092896D + motionZ * 0.20000000298023224D;

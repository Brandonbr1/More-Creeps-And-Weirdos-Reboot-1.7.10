...
public class CREEPSEntityEvilSnowman extends EntityMob {
    ...
    protected void attackEntity(Entity entity, float f) {
        if (this.onGround) {
            ...
            // Use same equation from ted for snowman, as that makes it so the entity can actually hit you properly.
            if (this.attackTime <= 0 && f < (double)(3.1F - (2.5F - this.snowsize)) && entity.boundingBox.maxY > this.boundingBox.minY && entity.boundingBox.minY < this.boundingBox.maxY)
            {

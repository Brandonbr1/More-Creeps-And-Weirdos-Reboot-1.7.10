...
public class CREEPSEntitySnowDevil extends EntityMob {
    ...
    protected Entity findPlayerToAttack() {
        ...
        if (entityplayer != null && (!this.tamed || this.rand.nextInt(10) == 0))
            return entityplayer;
    ...
    public boolean interact(EntityPlayer entityplayer) {
        ...
        if (this.tamed && entityplayer.isSneaking()) {
            entityplayer.openGui(MoreCreepsAndWeirdos.INSTANCE, 7, this.world, (int) this.posX, (int) this.posY, (int) this.posZ);
        }

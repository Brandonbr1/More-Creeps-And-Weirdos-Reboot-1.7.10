...
public class CREEPSEntitySnowDevil extends EntityMob {
    ...
    public float health;
    static final String Names[] = { "Satan", "The Butcher", "Killer", "Tad", "Death Spanker", "Death Toll", "Bruiser",
        "Bones", "The Devil", "Little Devil", "Skinny", "Death to All", "I Will Hurt You", "Pierre", "Bonecruncher",
        "Bone Breaker", "Blood 'N Guts", "Kill Kill", "Murder", "The Juicer", "Scream", "Bloody Buddy", "Sawblade",
        "Ripper", "Razor", "Valley Strangler", "Choppy Joe", "Wiconsin Shredder", "Urinal", "Johnny Choke",
    ...
    static final String snowTextures[] = { "morecreeps:textures/entity/snowdevil1.png",
        "morecreeps:textures/entity/snowdevil2.png" };
    ...
    public EntityLiving getClosestTarget(Entity entity, double d) {
        ...
        List<Entity> list = this.worldObj.getEntitiesWithinAABBExcludingEntity(this, boundingBox.expand(20D, 20D, 20D));
    ...
    public boolean getCanSpawnHere() {
        ...
        return (i1 == Blocks.snow || j1 == Blocks.snow) && i1 != Blocks.cobblestone
            && i1 != Blocks.planks
            && i1 != Blocks.wool
    ...
    public boolean interact(EntityPlayer entityplayer) {
        ...
        if (this.tamed && entityplayer.isSneaking()) {
            MoreCreepsAndWeirdos.guiHandler
                .tryOpenGui(CREEPSGuiHandler.GuiType.ZEBRA_NAME.id, entityplayer, this.worldObj, this.getEntityId());
        }

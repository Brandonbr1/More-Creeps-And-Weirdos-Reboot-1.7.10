...
public class CREEPSEntityArmyGuy extends EntityMob implements IRangedAttackMob, IEntityAdditionalSpawnData {
    ...
    public void onLivingUpdate() {
        ...
        if (health < 60 && health > 50 && !this.helmet) {
            ...
            creepsentityarmyguyarm1
                .setLocationAndAngles(this.posX, this.posY + 1.0D, this.posZ, this.rotationYaw, 0.0F);
    ...
    static class AINearestAttackableTarget extends EntityAINearestAttackableTarget {
        ...
        public AINearestAttackableTarget(final CREEPSEntityArmyGuy p_i45858_1_,
            Class<? extends net.minecraft.entity.Entity> p_i45858_2_, int p_i45858_3_, boolean p_i45858_4_,
            boolean p_i45858_5_, final IEntitySelector mobselector) {

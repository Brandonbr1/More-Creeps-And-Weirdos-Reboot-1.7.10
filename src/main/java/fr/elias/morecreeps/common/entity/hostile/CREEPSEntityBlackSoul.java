...
public class CREEPSEntityBlackSoul extends EntityMob {
  ...
  public CREEPSEntityBlackSoul(World world) {
    ...
    texture =
        new ResourceLocation(
            Reference.MOD_ID, Reference.TEXTURE_PATH_ENTITES + Reference.TEXTURE_BLACK_SOUL);
    modelsize = 1.0F;
  ...
  public boolean getCanSpawnHere() {
     ...
     * return i1 != Blocks.cobblestone && i1 != Blocks.log && i1 != Blocks.planks && i1 != Blocks.wool &&
     * worldObj.getCollidingBoundingBoxes(this, getBoundingBox()).size() == 0 && rand.nextInt(15) == 0 && j1 < 10;
     */
  }

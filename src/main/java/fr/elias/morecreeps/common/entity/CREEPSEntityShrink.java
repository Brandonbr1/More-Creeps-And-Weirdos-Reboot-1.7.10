...
public class CREEPSEntityShrink extends EntityThrowable {
    ...
    public void onUpdate() {
        ...
        if (worldObj.isRemote) MoreCreepsAndWeirdos.proxy.shrinkSmoke(worldObj, this);
    ...
    public void blast() {
        if (worldObj.isRemote) MoreCreepsAndWeirdos.proxy.shrinkBlast(worldObj, this, rand);
    }

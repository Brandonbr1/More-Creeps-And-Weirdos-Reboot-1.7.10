...
public class CREEPSEntityCamelJockey extends EntityMob {
    ...
    public double getYOffset() {
        if (this.ridingEntity instanceof CREEPSEntityCamel)
            return this.getYOffset() + 1.5F;
        else
    ...
    protected void attackEntity(Entity entity, float f) {
        ...
        if (f < 2D && entity.boundingBox != null && this.boundingBox != null
    ...
    public void playLivingSound() {
        ...
        if (s != null) {
            this.worldObj.playSoundAtEntity(
                    ...
                    s,
                    this.getSoundVolume(),
                    (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F + 1.0F + (0.6F - this.modelsize) * 2.0F);
        }
    }

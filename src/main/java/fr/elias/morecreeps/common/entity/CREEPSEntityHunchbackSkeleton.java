...
public class CREEPSEntityHunchbackSkeleton extends EntityMob {
    ...
    protected Entity findPlayerToAttack() {
        ...
        if ((this.getAttackTarget() instanceof EntityPlayer)
            || (this.getAttackTarget() instanceof CREEPSEntityHunchbackSkeleton)) {
            return null;
        } else {
            return entityliving;
        }
    ...
    public EntityLiving getClosestTarget(Entity entity, double d) {
        ...
        for (int i = 0; i < worldObj.loadedEntityList.size(); i++) {
            ...
            if (!(entity1 instanceof EntityLiving) || entity1 == entity
                ...
                || (entity1 instanceof CREEPSEntityGuineaPig)
                || (entity1 instanceof CREEPSEntitySnowDevil)
                || (entity1 instanceof CREEPSEntityHunchbackSkeleton)
                || (entity1 instanceof CREEPSEntityHunchback)) {
                continue;
            }
    ...
    protected void attackEntity(Entity entity, float f) {
        if ((entity instanceof EntityPlayer) || (entity instanceof CREEPSEntityHunchback)

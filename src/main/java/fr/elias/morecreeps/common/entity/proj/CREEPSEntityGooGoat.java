...
public class CREEPSEntityGooGoat extends EntityAnimal {
	...
	//	this.goatsize = 0.7F;
		...
		this.setEntitySize(0.7F /** this.width * this.goatsize, this.height * this.goatsize **/
		);
	...
	public void setEntitySize(float size /** float width, float height **/
	) {
		this.dataWatcher.updateObject(27, Float.valueOf(size));
		//this.dataWatcher.updateObject(16, new Byte((byte) size));
		this.setSize(this.width * size, this.height * size);
	...
	protected void entityInit() {
		super.entityInit();
		this.dataWatcher.addObject(27, Float.valueOf(0.7f));
	}
	...
	public void onLivingUpdate() {
		...
		if (!this.worldObj.isRemote && hungry) {
			...
			if (l == Blocks.grass && this.rand.nextInt(10) == 0) {
				...
				if (this.hungrytime > 300 && this.goatlevel < 5) {
					this.hungry = false;
					this.hungrytime = 0;
					this.setEntitySize(this.getSlimeSize() + 0.2F);
				//	this.goatsize = this.goatsize + 0.2F;
					this.goatlevel++;
					this.attack++;
					this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(15 * this.goatlevel + 25);
					this.texture = "morecreeps:textures/entity/googoat" + this.goatlevel + ".png";
					this.worldObj.playSoundAtEntity(this, "morecreeps:googoatstretch", 1.0F,
	...
	public EntityLivingBase getClosestTarget(Entity entity, double d) {
		...
		for (int i = 0; i < this.worldObj.loadedEntityList.size(); i++) {
			...
			if (!(entity1 instanceof EntityLiving) || entity1 == entity || entity1 == entity.riddenByEntity
					|| entity1 == entity.ridingEntity || (entity1 instanceof EntityPlayer)
					|| (entity1 instanceof EntityMob) || (entity1 instanceof EntityAnimal)) {
				continue;
			}
	...
	public boolean getCanSpawnHere() {
		...
		return (i1 == Blocks.grass || i1 == Blocks.dirt) && i1 != Blocks.cobblestone && i1 != Blocks.log
				...
				&& this.worldObj.canBlockSeeTheSky(i, j, k) && this.rand.nextInt(40) == 0 && l > 7;
	}
	...
	public void writeEntityToNBT(NBTTagCompound nbttagcompound) {
		...
		nbttagcompound.setFloat("GoatSize", this.getSlimeSize() /**this.goatsize**/);
	...
	public void readEntityFromNBT(NBTTagCompound nbttagcompound) {
		...
		float i = nbttagcompound.getFloat("GoatSize");
		this.setEntitySize(i);

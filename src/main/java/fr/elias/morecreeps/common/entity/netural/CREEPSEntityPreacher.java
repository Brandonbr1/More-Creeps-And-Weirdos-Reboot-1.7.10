...
public class CREEPSEntityPreacher extends EntityMob {
  ...
  public CREEPSEntityPreacher(World world) {
    ...
    this.targetTasks.addTask(
        1, new EntityAINearestAttackableTarget(this, EntitySheep.class, 0, true));
    this.targetTasks.addTask(
        2, new EntityAINearestAttackableTarget(this, EntityPig.class, 0, true));
  }
  ...
  public void onUpdate() {
    ...
    if (this.rand.nextInt(4) == 0) {
      this.texture =
          (new StringBuilder())
              .append("morecreeps:textures/entity/preacher")
  ...
  public void onLivingUpdate() {
    ...
    if (this.ritual && !this.getvictim) {
      ...
      for (int k = 0; k < this.worldObj.loadedEntityList.size(); k++) {
        ...
        if ((this.targetedEntity instanceof EntitySheep)
            || (this.targetedEntity instanceof EntityPig)) {
          this.getvictim = true;
  ...
  public boolean getCanSpawnHere() {
    ...
    if (this.posX == 0 && this.posY == 0 && this.posZ == 0) return false;
    int i = MathHelper.floor_double(this.posX);
  ...
  public boolean attackEntityFrom(DamageSource damagesource, float i) {
    ...
    if (obj != null) {
      ...
      if ((obj instanceof CREEPSEntityGooDonut)
          || (obj instanceof CREEPSEntityRocket)

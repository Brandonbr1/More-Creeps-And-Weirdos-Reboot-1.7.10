...
public class CREEPSEntityGrow extends EntityItem implements IProjectile {
    ...
    public CREEPSEntityGrow(World world, EntityLivingBase entityliving, float f) {
        ...
        setThrowableHeading(
            ...
            motionY,
            motionZ,
            (float) (2.5D + ((double) worldObj.rand.nextFloat() - 0.5D)),
            f1);
    }
    ...
    public void onUpdate() {
        ...
        for (int j = 0; j < list.size(); j++) {
            ...
            if (!entity1.canBeCollidedWith()
                || (entity1 == lightValueOwn || lightValueOwn != null && entity1 == lightValueOwn.ridingEntity)
            ...
            if (movingobjectposition.entityHit != null) {
                if (movingobjectposition.entityHit instanceof EntityLiving) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityKid)
                        && ((CREEPSEntityKid) movingobjectposition.entityHit).modelsize < 5F) {
                        ((CREEPSEntityKid) movingobjectposition.entityHit).modelsize += 0.15F;
                        ((CREEPSEntityKid) movingobjectposition.entityHit).setEntitySize(
                            ((CREEPSEntityKid) movingobjectposition.entityHit).modelsize,
                            ((CREEPSEntityKid) movingobjectposition.entityHit).modelsize);
                    }

                    if ((movingobjectposition.entityHit instanceof CREEPSEntityBigBaby)
                        && ((CREEPSEntityBigBaby) movingobjectposition.entityHit).modelsize < 8F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityRatMan)
                        && ((CREEPSEntityRatMan) movingobjectposition.entityHit).modelsize < 3F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityGuineaPig)
                        && ((CREEPSEntityGuineaPig) movingobjectposition.entityHit).modelsize < 5F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityHotdog)
                        && ((CREEPSEntityHotdog) movingobjectposition.entityHit).dogsize < 5F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityRobotTed)
                        && ((CREEPSEntityRobotTed) movingobjectposition.entityHit).robotsize < 6F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityRobotTodd)
                        && ((CREEPSEntityRobotTodd) movingobjectposition.entityHit).robotsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityGooGoat)
                        && ((CREEPSEntityGooGoat) movingobjectposition.entityHit).goatsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityLolliman)
                        && ((CREEPSEntityLolliman) movingobjectposition.entityHit).modelsize < 6F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityCastleCritter)
                        && ((CREEPSEntityCastleCritter) movingobjectposition.entityHit).modelsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntitySneakySal)
                        && ((CREEPSEntitySneakySal) movingobjectposition.entityHit).modelsize < 6F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityArmyGuy)
                        && ((CREEPSEntityArmyGuy) movingobjectposition.entityHit).modelsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityEvilChicken)
                        && ((CREEPSEntityEvilChicken) movingobjectposition.entityHit).modelsize < 5F) {
                        ...
                        ((CREEPSEntityEvilChicken) movingobjectposition.entityHit)
                            ...
                            .setBaseValue(0.2D + 0.015D);
                    }

                    if ((movingobjectposition.entityHit instanceof CREEPSEntityBum)
                        && ((CREEPSEntityBum) movingobjectposition.entityHit).modelsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityBubbleScum)
                        && ((CREEPSEntityBubbleScum) movingobjectposition.entityHit).modelsize < 3F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityLawyerFromHell)
                        && ((CREEPSEntityLawyerFromHell) movingobjectposition.entityHit).modelsize < 5F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityG)
                        && ((CREEPSEntityG) movingobjectposition.entityHit).modelsize < 5F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityRockMonster)
                        && ((CREEPSEntityRockMonster) movingobjectposition.entityHit).modelsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityBabyMummy)
                        && ((CREEPSEntityBabyMummy) movingobjectposition.entityHit).babysize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityBlackSoul)
                        && ((CREEPSEntityBlackSoul) movingobjectposition.entityHit).modelsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityBlorp)
                        && ((CREEPSEntityBlorp) movingobjectposition.entityHit).blorpsize
                            < (float) CREEPSConfig.sblorpmaxsize) {
                        ((CREEPSEntityBlorp) movingobjectposition.entityHit).blorpsize += 0.25F;
                        setSize(
                            ((CREEPSEntityBlorp) movingobjectposition.entityHit).blorpsize + 1.0F,
                            ((CREEPSEntityBlorp) movingobjectposition.entityHit).blorpsize * 2.0F + 2.0F);
                    }

                    if ((movingobjectposition.entityHit instanceof CREEPSEntityCamel)
                        && ((CREEPSEntityCamel) movingobjectposition.entityHit).modelsize < 5F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityCamelJockey)
                        && ((CREEPSEntityCamelJockey) movingobjectposition.entityHit).modelsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityCastleGuard)
                        && ((CREEPSEntityCastleGuard) movingobjectposition.entityHit).modelsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityCaveman)
                        && ((CREEPSEntityCaveman) movingobjectposition.entityHit).modelsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityDesertLizard)
                        && ((CREEPSEntityDesertLizard) movingobjectposition.entityHit).modelsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityDigBug)
                        && ((CREEPSEntityDigBug) movingobjectposition.entityHit).modelsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityEvilCreature)
                        && ((CREEPSEntityEvilCreature) movingobjectposition.entityHit).modelsize < 7F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityEvilPig)
                        && ((CREEPSEntityEvilPig) movingobjectposition.entityHit).modelsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityEvilScientist)
                        && ((CREEPSEntityEvilScientist) movingobjectposition.entityHit).modelsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityEvilSnowman)
                        && ((CREEPSEntityEvilSnowman) movingobjectposition.entityHit).snowsize < 7F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityFloob)
                        && ((CREEPSEntityFloob) movingobjectposition.entityHit).modelsize < 5F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityHippo)
                        && ((CREEPSEntityHippo) movingobjectposition.entityHit).modelsize < 5F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityHunchback)
                        && ((CREEPSEntityHunchback) movingobjectposition.entityHit).modelsize < 5F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityHunchbackSkeleton)
                        && ((CREEPSEntityHunchbackSkeleton) movingobjectposition.entityHit).modelsize < 5F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityInvisibleMan)
                        && ((CREEPSEntityInvisibleMan) movingobjectposition.entityHit).modelsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityManDog)
                        && ((CREEPSEntityManDog) movingobjectposition.entityHit).modelsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityNonSwimmer)
                        && ((CREEPSEntityNonSwimmer) movingobjectposition.entityHit).modelsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityRocketGiraffe)
                        && ((CREEPSEntityRocketGiraffe) movingobjectposition.entityHit).modelsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntitySnowDevil)
                        && ((CREEPSEntitySnowDevil) movingobjectposition.entityHit).modelsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityThief)
                        && ((CREEPSEntityThief) movingobjectposition.entityHit).modelsize < 4F) {
                    ...
                    if ((movingobjectposition.entityHit instanceof CREEPSEntityZebra)
                        && ((CREEPSEntityZebra) movingobjectposition.entityHit).modelsize < 5F) {
        ...
        if (worldObj.isRemote) MoreCreepsAndWeirdos.proxy.growParticle(worldObj, this);
    ...
    public void blast() {
        if (worldObj.isRemote) MoreCreepsAndWeirdos.proxy.shrinkParticle(worldObj, this);
    }

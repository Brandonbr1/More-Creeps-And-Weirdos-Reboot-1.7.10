...
public class EntityBlorpAI extends EntityAIBase {
    ...
    public EntityLivingBase getClosestTarget(Entity entity, double d) {
        ...
        for (int i = 0; i < blorp.worldObj.loadedEntityList.size(); i++) {
            ...
            if (!(entity1 instanceof EntityLivingBase) || entity1 == entity
                || entity1 == entity.riddenByEntity
                || entity1 == entity.ridingEntity
                || (entity1 instanceof EntityPlayer)
                || (entity1 instanceof EntityMob)
                || (entity1 instanceof EntityAnimal) && !(entity1 instanceof CREEPSEntityBlorp)) {
                continue;
            }

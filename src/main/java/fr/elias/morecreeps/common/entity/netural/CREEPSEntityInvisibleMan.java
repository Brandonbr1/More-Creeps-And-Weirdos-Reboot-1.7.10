...
public class CREEPSEntityInvisibleMan extends EntityMob {
    ...
    class AIAttackEntity extends EntityAIBase {
        ...
        public void updateTask() {
            try {
                float f = CREEPSEntityInvisibleMan.this.getDistanceToEntity(CREEPSEntityInvisibleMan.this.getAttackTarget());
                if (f < 256F) {
    ...
    protected void attackEntity(Entity entity, float f) {
        if (this.onGround) {
            ...
            this.motionZ = (d1 / f1) * 0.20000000000000001D * 0.80000001192092896D + this.motionZ * 0.20000000298023224D;

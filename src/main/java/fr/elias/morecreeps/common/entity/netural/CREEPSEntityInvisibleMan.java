...
public class CREEPSEntityInvisibleMan extends EntityMob {
  ...
  class AIAttackEntity extends EntityAIBase {
    ...
    public void updateTask() {
      try {
        float f =
            CREEPSEntityInvisibleMan.this.getDistanceToEntity(
                CREEPSEntityInvisibleMan.this.getAttackTarget());
        if (f < 256F) {
          CREEPSEntityInvisibleMan.this.attackEntity(
              CREEPSEntityInvisibleMan.this.getAttackTarget(), f);
          CREEPSEntityInvisibleMan.this
              .getLookHelper()
              .setLookPositionWithEntity(
                  CREEPSEntityInvisibleMan.this.getAttackTarget(), 10.0F, 10.0F);
        ...
        if (f < 1F) {
          CREEPSEntityInvisibleMan.this.attackEntityAsMob(
              CREEPSEntityInvisibleMan.this.getAttackTarget());
        }
  ...
  protected void attackEntity(Entity entity, float f) {
    if (this.onGround) {
      ...
      this.motionX =
          (d / f1) * 0.20000000000000001D * 0.80000001192092896D
              + this.motionX * 0.20000000298023224D;
      this.motionZ =
          (d1 / f1) * 0.20000000000000001D * 0.80000001192092896D

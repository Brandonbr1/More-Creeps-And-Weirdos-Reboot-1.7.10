...
public class CREEPSEntityBigBaby extends EntityMob {
  ...
  public CREEPSEntityBigBaby(World world) {
    ...
    this.texture =
        new ResourceLocation(
            Reference.MOD_ID, Reference.TEXTURE_PATH_ENTITES + Reference.TEXTURE_BIGBABY0);
  ...
  public void onLivingUpdate() {
    if (this.skinTimer++ > 60) {
      ...
      this.texture =
          new ResourceLocation(
              Reference.MOD_ID,
              Reference.TEXTURE_PATH_ENTITES
                  + (new StringBuilder())
                      .append(Reference.TEXTURE_BIGBABY)
  ...
  public boolean attackEntityFrom(DamageSource damagesource, float i) {
    ...
    this.texture =
        new ResourceLocation(
            Reference.MOD_ID, Reference.TEXTURE_PATH_ENTITES + Reference.TEXTURE_BIGBABYBOP);
    this.skinTimer = 45;

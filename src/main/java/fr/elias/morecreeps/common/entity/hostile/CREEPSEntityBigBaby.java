...
public class CREEPSEntityBigBaby extends EntityMob {
    ...
    public void attackEntity(Entity entity, float f) {
        ...
        if (f < this.modelsize * 0.69999999999999996D + 1.5D && entity.boundingBox.maxY > this.boundingBox.minY
    ...
    public boolean attackEntityFrom(DamageSource damagesource, float i) {
        ...
        this.texture = new ResourceLocation(
            Reference.MOD_ID,
            Reference.TEXTURE_PATH_ENTITES + Reference.TEXTURE_BIGBABYBOP);
        this.skinTimer = 45;
        ...
        if (itemstack != null && itemstack.getItem() == MoreCreepsAndWeirdos.babyjarempty) {
            if (this.modelsize < 1.0F) {
                ...
                MoreCreepsAndWeirdos.proxy
                    .addChatMessage(this.worldObj, "Now turn that Baby into a Schlump on the floor");

...
public class CREEPSEntityLawyerFromHell extends EntityMob {
    ...
    class AIAttackEntity extends EntityAIBase {
        ...
        public void updateTask() {
            try {
                ...
                float f = CREEPSEntityLawyerFromHell.this
                    .getDistanceToEntity(CREEPSEntityLawyerFromHell.this.getAttackTarget());
                if (f < 256F) {
                ...
                if (f < 1F) {
                    CREEPSEntityLawyerFromHell.this
                        .attackEntityAsMob(CREEPSEntityLawyerFromHell.this.getAttackTarget());
                }
    ...
    protected void attackEntity(Entity entity, float f) {
        ...
        if (this.getAttackTarget() instanceof EntityPlayer) {
            ...
            if (this.onGround) {
                ...
                this.motionX = ((d / f2) * 0.5D * 0.40000001192092893D + this.motionX * 0.20000000298023224D) * f1;
                this.motionZ = ((d1 / f2) * 0.5D * 0.30000001192092896D + this.motionZ * 0.20000000298023224D) * f1;
                ...
                && MoreCreepsAndWeirdos.INSTANCE.currentfine >= 2500) {
                    ...
                    MoreCreepsAndWeirdos.proxy
                        .addChatMessage(this.worldObj, "\2474  BUSTED! \2476Sending guilty player to Jail");
                    MoreCreepsAndWeirdos.proxy
                        .addChatMessage(this.worldObj, ". . . . . . . . . . . . . . . . . . . . . . . . . . . . . .");
                    this.buildJail((EntityPlayer) entity);
                }
    ...
    public boolean buildJail(EntityPlayer entityplayersp) {
        ...
        if (MoreCreepsAndWeirdos.INSTANCE.jailBuilt) {
            ...
            if (!blockExists(this.worldObj, this.jailX, this.jailY, this.jailZ - 31)
                ...
                || !blockExists(this.worldObj, this.jailX + 14, this.jailY, this.jailZ + 45)) return false;
            ...
            if (this.area <= this.maxObstruct) {
                ...
                for (int j5 = 0; j5 < i4 - this.jailY; j5++) {
                    if (l4 == 0) {
                        this.worldObj
                            .setBlock(this.jailX + byte0, this.jailY + j5, this.jailZ + byte1, Blocks.stone_stairs);
                        this.worldObj
                            .setBlock(this.jailX + byte0, this.jailY + j5, this.jailZ + byte1, Blocks.stone_stairs);
                    }
                    ...
                    if (l4 == 1) {
                        this.worldObj
                            .setBlock(this.jailX + byte0 + 1, this.jailY + j5, this.jailZ + byte1, Blocks.stone_stairs);
                        this.worldObj
                            .setBlock(this.jailX + byte0 + 1, this.jailY + j5, this.jailZ + byte1, Blocks.stone_stairs);
                    }
                    ...
                    if (l4 == 3) {
                        this.worldObj
                            .setBlock(this.jailX + byte0, this.jailY + j5, this.jailZ + byte1 + 1, Blocks.stone_stairs);
                        this.worldObj
                            .setBlock(this.jailX + byte0, this.jailY + j5, this.jailZ + byte1 + 1, Blocks.stone_stairs);
                    }
                    ...
                    for (int k7 = 0; k7 < 3; k7++) {
                        for (int i8 = 0; i8 < 3; i8++) {
                            for (int l8 = 0; l8 < 4; l8++) {
                                this.worldObj
                                    .setBlockToAir(this.jailX + 10 + i8, this.jailY + l8, (this.jailZ - i6 * 7) + k7);
                                this.worldObj
                                    .setBlockToAir(this.jailX + 2 + i8, this.jailY + l8, (this.jailZ - i6 * 7) + k7);
                                this.worldObj.setBlockToAir(
                                    this.jailX + 10 + i8,
                                    this.jailY + l8,
                                    this.jailZ + i6 * 7 + 12 + k7);
                                this.worldObj
                                    .setBlockToAir(this.jailX + 2 + i8, this.jailY + l8, this.jailZ + i6 * 7 + 12 + k7);
                            }
                        }
                    }
                }
                ...
                for (int j6 = 0; j6 < 4; j6++) {
                    this.worldObj
                        .setBlock(this.jailX + 5, this.jailY + 1, this.jailZ - j6 * 7 - 5 - 2, Blocks.iron_bars);
                    ...
                    this.worldObj.setBlock(this.jailX + 5, this.jailY + 1, this.jailZ - j6 * 7 - 5, Blocks.wooden_door);
                    this.worldObj
                        .setBlock(this.jailX + 9, this.jailY + 1, this.jailZ - j6 * 7 - 5 - 2, Blocks.iron_bars);
                    ...
                    this.worldObj.setBlock(this.jailX + 9, this.jailY + 1, this.jailZ - j6 * 7 - 5, Blocks.wooden_door);
                    this.worldObj
                        .setBlock(this.jailX + 5, this.jailY + 1, this.jailZ + j6 * 7 + 19 + 2, Blocks.iron_bars);
                    this.worldObj.setBlock(this.jailX + 5, this.jailY, this.jailZ + j6 * 7 + 19, Blocks.wooden_door);
                    this.worldObj.setBlock(this.jailX + 5, this.jailY, this.jailZ + j6 * 7 + 19, Blocks.wooden_door);
                    this.worldObj
                        .setBlock(this.jailX + 5, this.jailY + 1, this.jailZ + j6 * 7 + 19, Blocks.wooden_door);
                    this.worldObj
                        .setBlock(this.jailX + 5, this.jailY + 1, this.jailZ + j6 * 7 + 19, Blocks.wooden_door);
                    this.worldObj
                        .setBlock(this.jailX + 9, this.jailY + 1, this.jailZ + j6 * 7 + 19 + 2, Blocks.iron_bars);
                    ...
                    this.worldObj.setBlock(this.jailX + 9, this.jailY, this.jailZ + j6 * 7 + 19, Blocks.wooden_door);
                    this.worldObj
                        .setBlock(this.jailX + 9, this.jailY + 1, this.jailZ + j6 * 7 + 19, Blocks.wooden_door);
                    this.worldObj
                        .setBlock(this.jailX + 9, this.jailY + 1, this.jailZ + j6 * 7 + 19, Blocks.wooden_door);
        ...
        for (int k8 = 1; k8 < tileentitychest3.getSizeInventory(); k8++) {
            ...
            if (i9 == 1) {
                tileentitychest3.setInventorySlotContents(
                    k8,
                    new ItemStack(MoreCreepsAndWeirdos.bandaid, this.rand.nextInt(2) + 1, 0));
            }

            if (i9 == 2) {
                tileentitychest3.setInventorySlotContents(
                    k8,
                    new ItemStack(MoreCreepsAndWeirdos.money, this.rand.nextInt(24) + 1, 0));
            }
        }
        ...
        List<?> list = this.worldObj
            .getEntitiesWithinAABBExcludingEntity(entityplayersp, (entityplayersp).boundingBox.expand(4D, 4D, 4D));
    ...
    public void populateCell(int i, int j, World world, EntityPlayer entityplayer, boolean flag) {
        if (flag) {
            List<?> list = world
                .getEntitiesWithinAABBExcludingEntity(entityplayer, entityplayer.boundingBox.expand(26D, 26D, 26D));

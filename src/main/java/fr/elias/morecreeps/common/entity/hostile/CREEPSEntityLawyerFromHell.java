...
public class CREEPSEntityLawyerFromHell extends EntityMob {
  ...
  protected Entity findPlayerToAttack() {
    if (this.lawyerstate == 0 && !this.undead) return null;
  ...
  public void onLivingUpdate() {
    this.texture =
        this.undead
            ? "morecreeps:textures/entity/lawyerfromhellundead.png"
            : "morecreeps:textures/entity/lawyerfromhell.png";
    this.getEntityAttribute(SharedMonsterAttributes.movementSpeed)
        .setBaseValue(this.undead ? 0.24D : 0.44D);
  ...
  public boolean isEntityInsideOpaqueBlock() {
    if (this.undead && this.isCollided) return false;
  ...
  class AIAttackEntity extends EntityAIBase {
    ...
    public void updateTask() {
      try {
        ...
        if (!CREEPSEntityLawyerFromHell.this.undead
            && CREEPSEntityLawyerFromHell.this.lawyerstate == 0) {
          CREEPSEntityLawyerFromHell.this.entityToAttack = null;
          return;
        }

        float f =
            CREEPSEntityLawyerFromHell.this.getDistanceToEntity(
                CREEPSEntityLawyerFromHell.this.getAttackTarget());
        if (f < 256F) {
          CREEPSEntityLawyerFromHell.this.attackEntity(
              CREEPSEntityLawyerFromHell.this.getAttackTarget(), f);
          CREEPSEntityLawyerFromHell.this
              .getLookHelper()
              .setLookPositionWithEntity(
                  CREEPSEntityLawyerFromHell.this.getAttackTarget(), 10.0F, 10.0F);
        ...
        if (f < 1F) {
          CREEPSEntityLawyerFromHell.this.attackEntityAsMob(
              CREEPSEntityLawyerFromHell.this.getAttackTarget());
        }
  ...
  protected void attackEntity(Entity entity, float f) {
    ...
    if (this.getAttackTarget() instanceof EntityPlayer) {
      ...
      if (this.onGround) {
        ...
        this.motionX =
            ((d / f2) * 0.5D * 0.40000001192092893D + this.motionX * 0.20000000298023224D) * f1;
        this.motionZ =
            ((d1 / f2) * 0.5D * 0.30000001192092896D + this.motionZ * 0.20000000298023224D) * f1;
  ...
  public boolean buildJail(EntityPlayer entityplayersp) {
    ...
    if (MoreCreepsAndWeirdos.INSTANCE.jailBuilt) {
        ...
        do {
          ...
          for (int k1 = -1; k1 < 14; k1++) {
            for (int l2 = -1; l2 < 14; l2++) {
              if (this.worldObj.getBlock(this.jailX + k1, this.jailY + j, this.jailZ + l2)
                  == Blocks.air) {
                this.area++;
              }
      ...
      if (this.worldObj.getBlock(this.jailX + 15 + 1, this.jailY + 20, this.jailZ + 7)
              == Blocks.flowing_water
          || this.worldObj.getBlock(this.jailX + 15 + 1, this.jailY + 20, this.jailZ + 7)
              == Blocks.water) {
        this.area++;
      }
      ...
      if (this.area <= this.maxObstruct) {
            ...
            for (int i3 = -1; i3 < 16; i3++) {
              ...
              if (j4 < 1) {
                this.worldObj.setBlock(
                    this.jailX + i3, this.jailY + k, this.jailZ + l1, Blocks.gravel);
                continue;
              }

              if (j4 < 15) {
                this.worldObj.setBlock(
                    this.jailX + i3, this.jailY + k, this.jailZ + l1, Blocks.mossy_cobblestone);
              } else {
                this.worldObj.setBlock(
                    this.jailX + i3, this.jailY + k, this.jailZ + l1, Blocks.stone);
              }
            }
          }
        }
        ...
        for (int l = 0; l < 5; l++) {
          for (int i2 = 0; i2 < 13; i2++) {
            for (int j3 = 0; j3 < 13; j3++) {
              this.worldObj.setBlock(
                  this.jailX + j3, this.jailY + l, this.jailZ + i2 + 1, Blocks.air);
              this.worldObj.setBlock(
                  this.jailX + j3, this.jailY + l, this.jailZ + i2 + 1, Blocks.air);
            }
          }
        ...
        for (int i1 = 0; i1 < 5; i1++) {
          for (int j2 = 3; j2 < 11; j2++) {
            for (int k3 = 3; k3 < 11; k3++) {
              this.worldObj.setBlock(
                  this.jailX + k3, this.jailY + i1, this.jailZ + j2 + 1, Blocks.stone);
              this.worldObj.setBlock(
                  this.jailX + k3, this.jailY + i1, this.jailZ + j2 + 1, Blocks.stone);
            }
          }
        ...
        for (int j1 = 0; j1 < 5; j1++) {
          for (int k2 = 5; k2 < 9; k2++) {
            for (int l3 = 5; l3 < 9; l3++) {
              this.worldObj.setBlock(
                  this.jailX + l3, this.jailY + j1, this.jailZ + k2 + 1, Blocks.air);
              this.worldObj.setBlock(
                  this.jailX + l3, this.jailY + j1, this.jailZ + k2 + 1, Blocks.air);
            }
          }
        ...
        for (i4 = 80;
            this.worldObj.getBlock(this.jailX + byte0, i4, this.jailZ + byte1) == Blocks.air
                || this.worldObj.getBlock(this.jailX + byte0, i4, this.jailZ + byte1)
                    == Blocks.leaves
                || this.worldObj.getBlock(this.jailX + byte0, i4, this.jailZ + byte1) == Blocks.log;
            i4--) {}
        ...
        for (int k4 = 0; k4 < i4 - this.jailY; k4++) {
          for (int i5 = 0; i5 < 2; i5++) {
            for (int i7 = 0; i7 < 2; i7++) {
              this.worldObj.setBlock(
                  this.jailX + i5 + byte0, this.jailY + k4, this.jailZ + byte1 + i7, Blocks.air);
            }
          }
        }
        ...
        for (int j5 = 0; j5 < i4 - this.jailY; j5++) {
          if (l4 == 0) {
            this.worldObj.setBlock(
                this.jailX + byte0, this.jailY + j5, this.jailZ + byte1, Blocks.stone_stairs);
            this.worldObj.setBlock(
                this.jailX + byte0, this.jailY + j5, this.jailZ + byte1, Blocks.stone_stairs);
          }
          ...
          if (l4 == 1) {
            this.worldObj.setBlock(
                this.jailX + byte0 + 1, this.jailY + j5, this.jailZ + byte1, Blocks.stone_stairs);
            this.worldObj.setBlock(
                this.jailX + byte0 + 1, this.jailY + j5, this.jailZ + byte1, Blocks.stone_stairs);
          }
          ...
          if (l4 == 3) {
            this.worldObj.setBlock(
                this.jailX + byte0, this.jailY + j5, this.jailZ + byte1 + 1, Blocks.stone_stairs);
            this.worldObj.setBlock(
                this.jailX + byte0, this.jailY + j5, this.jailZ + byte1 + 1, Blocks.stone_stairs);
          }
        ...
        this.worldObj.setBlock(this.jailX + 13, this.jailY, this.jailZ + byte1, Blocks.iron_door);
        this.worldObj.setBlock(
            this.jailX + 13, this.jailY + 1, this.jailZ + byte1, Blocks.iron_door);
        this.worldObj.setBlock(
            this.jailX + 13, this.jailY + 1, this.jailZ + byte1, Blocks.iron_door);
        this.worldObj.setBlock(
            this.jailX + 15, this.jailY, this.jailZ + byte1, Blocks.stone_stairs);
        this.worldObj.setBlock(
            this.jailX + 15, this.jailY, this.jailZ + byte1, Blocks.stone_stairs);
            ...
            for (int i8 = 0; i8 < 3; i8++) {
              for (int l8 = 0; l8 < 4; l8++) {
                this.worldObj.setBlockToAir(
                    this.jailX + 10 + i8, this.jailY + l8, (this.jailZ - i6 * 7) + k7);
                this.worldObj.setBlockToAir(
                    this.jailX + 2 + i8, this.jailY + l8, (this.jailZ - i6 * 7) + k7);
                this.worldObj.setBlockToAir(
                    this.jailX + 10 + i8, this.jailY + l8, this.jailZ + i6 * 7 + 12 + k7);
                this.worldObj.setBlockToAir(
                    this.jailX + 2 + i8, this.jailY + l8, this.jailZ + i6 * 7 + 12 + k7);
              }
            }
          }
        }
        ...
        for (int j6 = 0; j6 < 4; j6++) {
          this.worldObj.setBlock(
              this.jailX + 5, this.jailY + 1, this.jailZ - j6 * 7 - 5 - 2, Blocks.iron_bars);
          this.worldObj.setBlock(
              this.jailX + 5, this.jailY, this.jailZ - j6 * 7 - 5, Blocks.wooden_door);
          this.worldObj.setBlock(
              this.jailX + 5, this.jailY, this.jailZ - j6 * 7 - 5, Blocks.wooden_door);
          this.worldObj.setBlock(
              this.jailX + 5, this.jailY + 1, this.jailZ - j6 * 7 - 5, Blocks.wooden_door);
          this.worldObj.setBlock(
              this.jailX + 5, this.jailY + 1, this.jailZ - j6 * 7 - 5, Blocks.wooden_door);
          this.worldObj.setBlock(
              this.jailX + 9, this.jailY + 1, this.jailZ - j6 * 7 - 5 - 2, Blocks.iron_bars);
          ...
          this.worldObj.setBlock(
              this.jailX + 9, this.jailY, this.jailZ - j6 * 7 - 5, Blocks.wooden_door);
          this.worldObj.setBlock(
              this.jailX + 9, this.jailY, this.jailZ - j6 * 7 - 5, Blocks.wooden_door);
          this.worldObj.setBlock(
              this.jailX + 9, this.jailY + 1, this.jailZ - j6 * 7 - 5, Blocks.wooden_door);
          this.worldObj.setBlock(
              this.jailX + 9, this.jailY + 1, this.jailZ - j6 * 7 - 5, Blocks.wooden_door);
          this.worldObj.setBlock(
              this.jailX + 5, this.jailY + 1, this.jailZ + j6 * 7 + 19 + 2, Blocks.iron_bars);
          this.worldObj.setBlock(
              this.jailX + 5, this.jailY, this.jailZ + j6 * 7 + 19, Blocks.wooden_door);
          this.worldObj.setBlock(
              this.jailX + 5, this.jailY, this.jailZ + j6 * 7 + 19, Blocks.wooden_door);
          this.worldObj.setBlock(
              this.jailX + 5, this.jailY + 1, this.jailZ + j6 * 7 + 19, Blocks.wooden_door);
          this.worldObj.setBlock(
              this.jailX + 5, this.jailY + 1, this.jailZ + j6 * 7 + 19, Blocks.wooden_door);
          this.worldObj.setBlock(
              this.jailX + 9, this.jailY + 1, this.jailZ + j6 * 7 + 19 + 2, Blocks.iron_bars);
          ...
          this.worldObj.setBlock(
              this.jailX + 9, this.jailY, this.jailZ + j6 * 7 + 19, Blocks.wooden_door);
          this.worldObj.setBlock(
              this.jailX + 9, this.jailY, this.jailZ + j6 * 7 + 19, Blocks.wooden_door);
          this.worldObj.setBlock(
              this.jailX + 9, this.jailY + 1, this.jailZ + j6 * 7 + 19, Blocks.wooden_door);
          this.worldObj.setBlock(
              this.jailX + 9, this.jailY + 1, this.jailZ + j6 * 7 + 19, Blocks.wooden_door);

          if (this.rand.nextInt(1) == 0) {
            this.worldObj.setBlock(
                this.jailX + 12, this.jailY + 2, this.jailZ - j6 * 7 - 5, Blocks.torch);
          }

          if (this.rand.nextInt(1) == 0) {
            this.worldObj.setBlock(
                this.jailX + 2, this.jailY + 2, this.jailZ - j6 * 7 - 5, Blocks.torch);
          }

          if (this.rand.nextInt(1) == 0) {
            this.worldObj.setBlock(
                this.jailX + 12, this.jailY + 2, this.jailZ + j6 * 7 + 19, Blocks.torch);
          }

          if (this.rand.nextInt(1) == 0) {
            this.worldObj.setBlock(
                this.jailX + 2, this.jailY + 2, this.jailZ + j6 * 7 + 19, Blocks.torch);
          }
        }
        ...
        for (int k6 = 0; k6 < 9; k6++) {
          if (this.rand.nextInt(2) == 0) {
            this.worldObj.setBlock(
                this.jailX + 6, this.jailY + 2, this.jailZ - k6 * 4 - 2, Blocks.torch);
          }

          if (this.rand.nextInt(2) == 0) {
            this.worldObj.setBlock(
                this.jailX + 8, this.jailY + 2, this.jailZ - k6 * 4 - 2, Blocks.torch);
          }

          if (this.rand.nextInt(2) == 0) {
            this.worldObj.setBlock(
                this.jailX + 6, this.jailY + 2, this.jailZ + k6 * 4 + 18, Blocks.torch);
          }

          if (this.rand.nextInt(2) == 0) {
            this.worldObj.setBlock(
                this.jailX + 8, this.jailY + 2, this.jailZ + k6 * 4 + 18, Blocks.torch);
          }
        }
      } else return false;
    }
    ...
    for (int k8 = 1; k8 < tileentitychest3.getSizeInventory(); k8++) {
      ...
      if (i9 == 1) {
        tileentitychest3.setInventorySlotContents(
            k8, new ItemStack(MoreCreepsAndWeirdos.bandaid, this.rand.nextInt(2) + 1, 0));
      }

      if (i9 == 2) {
        tileentitychest3.setInventorySlotContents(
            k8, new ItemStack(MoreCreepsAndWeirdos.money, this.rand.nextInt(24) + 1, 0));
      }
    }
    ...
    tileentitychest1.setInventorySlotContents(
        this.rand.nextInt(5), new ItemStack(Items.stone_pickaxe, 1, 0));
    tileentitychest1.setInventorySlotContents(
        this.rand.nextInt(5) + 5, new ItemStack(Items.apple, 1, 0));
    tileentitychest2.setInventorySlotContents(
        this.rand.nextInt(5) + 5, new ItemStack(Blocks.torch, this.rand.nextInt(16), 0));
    tileentitychest2.setInventorySlotContents(
        this.rand.nextInt(5), new ItemStack(Items.apple, 1, 0));
    ...
    for (int k9 = 0; k9 < 4; k9++) {
      for (int j10 = 0; j10 < 4; j10++) {
        ...
        if (this.rand.nextInt(3) == 0) {
          this.dropTreasure(
              this.worldObj, this.jailX + 12, this.jailY + 2, this.jailZ - k9 * 7 - 5 - 1);
        }

        if (this.rand.nextInt(3) == 0) {
          this.dropTreasure(
              this.worldObj, this.jailX + 2, this.jailY + 2, this.jailZ - k9 * 7 - 5 - 1);
        }

        if (this.rand.nextInt(3) == 0) {
          this.dropTreasure(
              this.worldObj, this.jailX + 12, this.jailY + 2, this.jailZ + k9 * 7 + 19 + 1);
        }

        if (this.rand.nextInt(3) == 0) {
          this.dropTreasure(
              this.worldObj, this.jailX + 2, this.jailY + 2, this.jailZ + k9 * 7 + 19 + 1);
        }
      }
    }
    ...
    for (int iter1 = 1; iter1 < this.rand.nextInt(5) + 3; iter1++) {
      CREEPSEntityLawyerFromHell creepsentitylawyerfromhell =
          new CREEPSEntityLawyerFromHell(this.worldObj);
      creepsentitylawyerfromhell.setLocationAndAngles(
          this.jailX + 8, this.jailY + 1, this.jailZ - 11 - 1, (entityplayersp).rotationYaw, 0.0F);
      creepsentitylawyerfromhell.undead = true;
      creepsentitylawyerfromhell
          .getEntityAttribute(SharedMonsterAttributes.maxHealth)
          .setBaseValue(10D);
      this.worldObj.spawnEntityInWorld(creepsentitylawyerfromhell);
      CREEPSEntityLawyerFromHell creepsentitylawyerfromhell2 =
          new CREEPSEntityLawyerFromHell(this.worldObj);
      creepsentitylawyerfromhell2.setLocationAndAngles(
          this.jailX + 8, this.jailY + 1, this.jailZ + 11 + 15, (entityplayersp).rotationYaw, 0.0F);
    ...
    for (int iter2 = 2; iter2 < this.rand.nextInt(3) + 3; iter2++) {
      CREEPSEntityLawyerFromHell creepsentitylawyerfromhell1 =
          new CREEPSEntityLawyerFromHell(this.worldObj);
      creepsentitylawyerfromhell1.setLocationAndAngles(
          this.jailX + iter2, this.jailY + 2, this.jailZ + 2, (entityplayersp).rotationYaw, 0.0F);
      creepsentitylawyerfromhell1.undead = true;
      creepsentitylawyerfromhell1
          .getEntityAttribute(SharedMonsterAttributes.maxHealth)
          .setBaseValue(10D);
      this.worldObj.spawnEntityInWorld(creepsentitylawyerfromhell1);
      CREEPSEntityLawyerFromHell creepsentitylawyerfromhell3 =
          new CREEPSEntityLawyerFromHell(this.worldObj);
      creepsentitylawyerfromhell3.setLocationAndAngles(
          this.jailX + 2, this.jailY + 2, this.jailZ + iter2, (entityplayersp).rotationYaw, 0.0F);
    ...
    List<?> list =
        this.worldObj.getEntitiesWithinAABBExcludingEntity(
            entityplayersp, (entityplayersp).boundingBox.expand(4D, 4D, 4D));
  ...
  public void populateCell(int i, int j, World world, EntityPlayer entityplayer, boolean flag) {
    if (flag) {
      List<?> list =
          world.getEntitiesWithinAABBExcludingEntity(
              entityplayer, entityplayer.boundingBox.expand(26D, 26D, 26D));
      ...
      for (int l = 0; l < list.size(); l++) {
        ...
        if ((entity instanceof CREEPSEntityHotdog) && ((CREEPSEntityHotdog) entity).tamed) {
          ...
          ((CREEPSEntityHotdog) entity)
              .setLocationAndAngles(i, this.jailY, j, entityplayer.rotationYaw, 0.0F);
          continue;
        }
    ...
    switch (k + 1) {
      ...
      case 3:
        ...
        creepsentitycameljockey.setLocationAndAngles(
            i, this.jailY, j, entityplayer.rotationYaw, 0.0F);
      ...
      case 5:
        ...
        creepsentityprisoner1.setLocationAndAngles(
            i, this.jailY, j, entityplayer.rotationYaw, 0.0F);
      ...
      default:
        ...
        creepsentityprisoner2.setLocationAndAngles(
            i, this.jailY, j, entityplayer.rotationYaw, 0.0F);
  ...
  protected String getLivingSound() {
    if (!this.undead) return "morecreeps:lawyer";
    else return "morecreeps:lawyerundead";
  }

  /** Returns the sound this mob makes when it is hurt. */
  @Override
  protected String getHurtSound() {
    if (!this.undead) return "morecreeps:lawyerhurt";
    else return "morecreeps:lawyerundeadhurt";
  }

  /** Returns the sound this mob makes on death. */
  @Override
  protected String getDeathSound() {
    if (!this.undead) return "morecreeps:lawyerdeath";
    else return "morecreeps:lawyerundeaddeath";
  }

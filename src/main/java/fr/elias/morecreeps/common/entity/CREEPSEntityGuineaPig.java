...
public class CREEPSEntityGuineaPig extends EntityMob {
    ...
    public boolean interact(EntityPlayer entityplayer) {
        ...
        if (itemstack != null && health > 0) {
            ...
            if (itemstack.getItem() == Item.getItemFromBlock(Blocks.red_flower) && tamed
                || itemstack.getItem() == Item.getItemFromBlock(Blocks.yellow_flower) && tamed) {
                smokePlain();
            ...
            if (tamed) {
                ...
                if (armor == Items.leather_boots || armor == Items.leather_chestplate
                    || armor == Items.leather_helmet
                ...
                if (armor == Items.golden_boots || armor == Items.golden_chestplate
                ...
                if (armor == Items.iron_boots || armor == Items.iron_chestplate
                ...
                if (armor == Items.diamond_boots || armor == Items.diamond_chestplate
                    || armor == Items.diamond_helmet

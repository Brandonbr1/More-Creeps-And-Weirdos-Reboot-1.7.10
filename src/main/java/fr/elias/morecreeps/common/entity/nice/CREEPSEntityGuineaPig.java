...
public class CREEPSEntityGuineaPig extends EntityMob {
    ...
    static final String Names[] = { "Sugar", "Clover", "CoCo", "Sprinkles", "Mr. Rabies", "Stinky",
        "The Incredible Mr. CoCoPants", "Butchie", "Lassie", "Fuzzy", "Nicholas", "Natalie", "Pierre", "Priscilla",
        "Mrs. McGillicutty", "Dr. Tom Jones", "Peter the Rat", "Wiskers", "Penelope", "Sparky", "Tinkles", "Ricardo",
        "Jimothy", "Captain Underpants", "CoCo Van Gough", "Chuck Norris", "PeeWee", "Quasimodo", "ZSA ZSA", "Yum Yum",
        "Deputy Dawg", "Henrietta Pussycat", "Bob Dog", "King Friday", "Jennifer", "The Situation", "Prince Charming",
        "Sid", "Sunshine", "Bubbles", "Carl", "Snowy", "Dorf", "Chilly Willy", "Angry Bob", "George W. Bush",
        "Ted Lange from The Love Boat", "Notch", "Frank", "A Very Young Pig", "Blaster", "Darwin", "Ruggles", "Chang",
        "Spaz", "Fluffy", "Fuzzy", "Charrlotte", "Tootsie", "Mary", "Caroline", "Michelle", "Sandy", "Peach", "Scrappy",
        "Roxanne", "James the Pest", "Lucifer", "Shaniqua", "Wendy", "Zippy", "Prescott Pig", "Pimpin' Pig",
        "Big Daddy", "Little Butchie", "The Force", "The Handler", "Little Louie", "Satin", "Sparkly Puff", "Dr. Chews",
        "Pickles", "Longtooth", "Jeffry", "Pedro the Paunchy", "Wee Willy Wiskers", "Tidy Smith", "Johnson", "Big Joe",
        "Tiny Mackeral", "Wonderpig", "Wee Wonderpig", "The Polish Baron", "Inconceivable", "Double Danny Dimples",
        "Jackie Jones", "Pistol", "Tiny Talker", "Strum", "Disco the Pig", "Banjo", "Fingers", "Clean Streak",
        "Little Sweet", "Fern", "Youngblood", "Lazy Cottonball", "Foxy", "SlyFoxHound" };
    static final String pigTextures[] = { "morecreeps:textures/entity/ggpig1.png",
        ...
        "morecreeps:textures/entity/ggpig6.png", "morecreeps:textures/entity/ggpig7.png",
        "morecreeps:textures/entity/ggpig8.png", "morecreeps:textures/entity/ggpig9.png",
    ...
    public static final String levelname[] = { "Guinea Pig", "A nothing pig", "An inexperienced pig", "Trainee",
        "Private", "Private First Class", "Corporal", "Sergeant", "Staff Sergeant", "Sergeant First Class",
        "Master Sergeant", "First Sergeant", "Sergeant Major", "Command Sergeant Major", "Second Lieutenant",
        "First Lieutenant", "Captain", "Major", "Lieutenant Colonel", "Colonel", "General of the Pig Army",
    ...
    protected void updateAITick() {
        ...
        if (!this.attackEntityAsMob(this.entitymain) && !this.hasPath()
            && this.tamed
        ...
        if (this.getAttackTarget() instanceof EntityPlayer && (this.getDistanceToEntity(this.entityplayer) < 6F)) {
            this.setAttackTarget(null);
        }

        if ((float) this.health < this.basehealth * (0.1F * this.skillhealing) && this.skillhealing > 0) {
    ...
    protected void attackEntity(Entity entity, float f) {
        if (!(this.getAttackTarget() instanceof EntityPlayer)
            ...
            if (this.onGround && this.tamed) {
                ...
                this.motionZ = (d2 / f2) * 0.5D * 0.80000001192092896D + this.motionZ * 0.20000000298023224D;
                ...
                if (this.rand.nextInt(100) > 100D - d1) {
                    ...
                    if (this.skillattack > 1 && this.rand.nextInt(100) > 100 - this.skillattack * 2
    ...
    public boolean interact(EntityPlayer entityplayer) {
        ...
        if (this.tamed && entityplayer.isSneaking()) {
            MoreCreepsAndWeirdos.guiHandler
                .tryOpenGui(CREEPSGuiHandler.GuiType.GUINEA_TRAIN.id, entityplayer, this.worldObj, this.getEntityId());
            return true;
        }
        ...
        if (itemstack != null && this.health > 0) {
            if ((itemstack.getItem() == Items.book || itemstack.getItem() == Items.paper
                ...
                MoreCreepsAndWeirdos.guiHandler
                    .tryOpenGui(CREEPSGuiHandler.GuiType.GUINEA.id, entityplayer, this.worldObj, this.getEntityId());
            }
                ...
                if (this.ridingEntity != null) {
                    ...
                    if (this.level >= 20) {
                        ...
                        MoreCreepsAndWeirdos.proxy
                            .addChatMessage(this.worldObj, "Your Guinea Pig must be level 20 to build a Hotel.");
                        MoreCreepsAndWeirdos.proxy.addChatMessage(
                            this.worldObj,
                            (new StringBuilder()).append("\247b")
                                .append(this.name)
            ...
            if (this.tamed) {
                ...
                if (this.armor == Items.leather_boots || this.armor == Items.leather_chestplate
                ...
                if (this.armor == Items.golden_boots || this.armor == Items.golden_chestplate
                ...
                if (this.armor == Items.iron_boots || this.armor == Items.iron_chestplate
                ...
                if (this.armor == Items.diamond_boots || this.armor == Items.diamond_chestplate
        ...
        if (l < 900) {
            ...
            for (int k1 = 0; k1 < byte1; k1++) {
                for (int i4 = 0; i4 < byte2; i4++) {
                    ...
                    for (int k5 = 0; k5 < byte0; k5++) {
                        ...
                        this.worldObj
                            .setBlockMetadataWithNotify(i + 0, j + k1, k + k5, Block.getIdFromBlock(Blocks.wool), 1);
                        ...
                        if (this.alt > 0) {
                            this.worldObj
                                .setBlockMetadataWithNotify(i + i4, j, k + k5, Block.getIdFromBlock(Blocks.wool), 10);

                        } else {
                            this.worldObj
                                .setBlockMetadataWithNotify(i + i4, j, k + k5, Block.getIdFromBlock(Blocks.wool), 11);
                        }
            ...
            for (int l5 = 0; l5 < tileentitychest.getSizeInventory(); l5++) {
                if (this.rand.nextInt(10) == 0) {
                    ...
                    tileentitychest1.setInventorySlotContents(l5, new ItemStack(Items.wheat, this.rand.nextInt(16), 0));
                }
            }
            ...
            for (int i6 = 0; i6 < tileentitychest1.getSizeInventory(); i6++) {
                if (this.rand.nextInt(15) == 0) {
                    ...
                    tileentitychest3.setInventorySlotContents(i6, new ItemStack(Items.wheat, this.rand.nextInt(16), 0));
                }
            }
        } else {
            MoreCreepsAndWeirdos.proxy.addChatMessage(this.worldObj, "Too many obstructions, choose another spot!");
        }
    }

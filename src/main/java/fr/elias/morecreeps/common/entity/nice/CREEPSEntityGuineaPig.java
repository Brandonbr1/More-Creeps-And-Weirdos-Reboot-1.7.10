...
public class CREEPSEntityGuineaPig extends EntityMob {
    ...
    protected void updateAITick() {
        ...
        if (!this.attackEntityAsMob(this.entitymain) && !this.hasPath() && this.tamed && this.ridingEntity == null && this.wanderstate != 2 && (this.entityplayer != null)) {
        ...
        if (!(this.getAttackTarget() instanceof EntityPlayer)
            ...
            if (this.onGround && this.tamed) {
                ...
                if (this.rand.nextInt(100) > 100D - d1) {
                    ...
                    if (this.skillattack > 1 && this.rand.nextInt(100) > 100 - this.skillattack * 2 && this.criticalHitCooldown-- < 1) {
        ...
        if (itemstack != null && this.health > 0) {
            ...
            if (itemstack.getItem() == Items.diamond && this.tamed) {
                if (this.ridingEntity != null) {
                    ...
                    .addChatMessage("Put your Guinea Pig down before building the Guinea Pig Hotel!");

...
public class CREEPSEntitySchlump extends EntityAnimal {
    ...
    public CREEPSEntitySchlump(World world) {
        super(world);
        this.texture = Reference.MOD_ID + ":" + Reference.TEXTURE_PATH_ENTITES + Reference.TEXTURE_SCHLUMP;
        this.moveSpeed = 0.0F;
    ...
    public boolean checkHouse(boolean showMessages) {
        ...
        if (flag) {
            if (showMessages) {
                MoreCreepsAndWeirdos.proxy
                    .addChatMessage(this.worldObj, "Too close to another Schlump. SCHLUMP OVERLOAD!");
        ...
        if (this.worldObj.canBlockSeeTheSky(i, j, k)) {
            if (showMessages) {
                MoreCreepsAndWeirdos.proxy
                    .addChatMessage(this.worldObj, "Your Schlump needs to be indoors or it will die!");
                this.worldObj.playSoundAtEntity(
                    this,
        ...
        if (this.worldObj.getBlockLightOpacity(i, j, k) > 11) {
            if (showMessages) {
                MoreCreepsAndWeirdos.proxy
                    .addChatMessage(this.worldObj, "It is too bright in here for your little Schlump!");
                this.worldObj.playSoundAtEntity(
                    this,
        ...
        for (int i1 = -2; i1 < 2; i1++) {
            for (int k1 = -2; k1 < 2; k1++) {
                for (int i2 = 0; i2 < 5; i2++) {
                    if (this.worldObj.getBlock((int) this.posX + i1, (int) this.posY + i2, (int) this.posZ + k1)
                        == Blocks.air) {
                        l++;
                    }
                }
        ...
        if (l < 60) {
            if (showMessages) {
                MoreCreepsAndWeirdos.proxy
                    .addChatMessage(this.worldObj, "Your Schlump doesn't have enough room to grow!");
                this.worldObj.playSoundAtEntity(
                    this,
        ...
        for (int l1 = -5; l1 < 5; l1++) {
            for (int j2 = -5; j2 < 5; j2++) {
                for (int k2 = -5; k2 < 5; k2++) {
                    Block l2 = this.worldObj.getBlock((int) this.posX + l1, (int) this.posY + k2, (int) this.posZ + j2);
        ...
        if (j1 > 275) {
            if (this.age < 10 && showMessages) {
                MoreCreepsAndWeirdos.proxy
                    .addChatMessage(this.worldObj, "This location is great! Your Schlump will love it here! ");
                this.worldObj.playSoundAtEntity(
                    this,
            ...
            if (showMessages) {
                MoreCreepsAndWeirdos.proxy
                    .addChatMessage(this.worldObj, "This is not a good location for your Schlump. It will die here! ");
                this.worldObj.playSoundAtEntity(
                    this,
    ...
    public boolean interact(EntityPlayer entityplayer) {
        ...
        if (itemstack != null && itemstack.getItem() == MoreCreepsAndWeirdos.babyjarempty) {
            if (this.modelsize > 0.5F) {
                MoreCreepsAndWeirdos.proxy.addChatMessage(this.worldObj, "That Schlump is too big to fit in a jar! ");
                this.worldObj.playSoundAtEntity(
                    this,
    ...
    public void giveReward() {
        ...
        if (this.entityplayer != null) {
            ...
            switch (i) {
                case 1:
                    entityitem = this
                        .entityDropItem(new ItemStack(MoreCreepsAndWeirdos.lolly, this.rand.nextInt(2) + 1, 0), 1.0F);
                    break;
                ...
                case 15:
                    entityitem = this
                        .entityDropItem(new ItemStack(MoreCreepsAndWeirdos.money, this.rand.nextInt(4) + 1, 0), 1.0F);
                    break;
                ...
                case 29:
                    entityitem = this
                        .entityDropItem(new ItemStack(MoreCreepsAndWeirdos.evilegg, this.rand.nextInt(5) + 1, 0), 1.0F);
                    break;
                ...
                case 32:
                    entityitem = this.entityDropItem(
                ...
                case 36:
                    entityitem = this
                        .entityDropItem(new ItemStack(MoreCreepsAndWeirdos.money, this.rand.nextInt(24) + 1, 0), 1.0F);
                    break;
                ...
                case 38:
                    entityitem = this.entityDropItem(new ItemStack(MoreCreepsAndWeirdos.horseheadgem, 1, 0), 1.0F);
                    break;
                ...
                case 42:
                    entityitem = this
                        .entityDropItem(new ItemStack(MoreCreepsAndWeirdos.money, this.rand.nextInt(49) + 1, 0), 1.0F);
                    break;

                default:
                    entityitem = this
                        .entityDropItem(new ItemStack(MoreCreepsAndWeirdos.money, this.rand.nextInt(3) + 1, 0), 1.0F);
                    break;
            }
            if (entityitem != null) {

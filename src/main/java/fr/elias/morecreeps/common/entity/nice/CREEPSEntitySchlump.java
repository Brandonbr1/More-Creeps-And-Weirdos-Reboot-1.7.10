        ...
        for (int i1 = -2; i1 < 2; i1++) {
            for (int k1 = -2; k1 < 2; k1++) {
                for (int i2 = 0; i2 < 5; i2++) {
                    if (this.worldObj.getBlock((int) this.posX + i1, (int) this.posY + i2, (int) this.posZ + k1) == Blocks.air) {
                        l++;
                    }
                }
            }
            ...
            switch (i) {
                case 1:
                    entityitem = this.entityDropItem(
                            new ItemStack(MoreCreepsAndWeirdos.lolly, this.rand.nextInt(2) + 1, 0),
                            1.0F);
                    break;
                ...
                case 15:
                    entityitem = this.entityDropItem(
                            new ItemStack(MoreCreepsAndWeirdos.money, this.rand.nextInt(4) + 1, 0),
                            1.0F);
                    break;
                ...
                case 29:
                    entityitem = this.entityDropItem(
                            new ItemStack(MoreCreepsAndWeirdos.evilegg, this.rand.nextInt(5) + 1, 0),
                            1.0F);
                    break;
                ...
                case 42:
                    entityitem = this.entityDropItem(
                            new ItemStack(MoreCreepsAndWeirdos.money, this.rand.nextInt(49) + 1, 0),
                            1.0F);
                    break;

                default:
                    entityitem = this.entityDropItem(
                            new ItemStack(MoreCreepsAndWeirdos.money, this.rand.nextInt(3) + 1, 0),
                            1.0F);
                    break;
            }
        ...
        for (int i = 1; i < 20; i++) {
            for (int j = 0; j < 10; j++) {
                CREEPSFxConfetti creepsfxconfetti = new CREEPSFxConfetti(
                        this.worldObj,
                        this.posX + (this.worldObj.rand.nextFloat() * 4F - this.worldObj.rand.nextFloat() * 4F),
                        this.posY + this.rand.nextInt(4) + 6D,
                        this.posZ + (this.worldObj.rand.nextFloat() * 4F - this.worldObj.rand.nextFloat() * 4F));

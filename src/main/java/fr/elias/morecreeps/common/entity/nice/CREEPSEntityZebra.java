...
public class CREEPSEntityZebra extends EntityAnimal {
    ...
    public boolean interact(EntityPlayer entityplayer) {
        ...
        if (this.tamed && entityplayer.isSneaking() && this.riddenByEntity == null) {
            entityplayer.openGui(MoreCreepsAndWeirdos.INSTANCE, 7, this.worldObj, (int) this.posX, (int) this.posY, (int) this.posZ);
            return true;
        }
    ...
    private void handleCookieInteraction(EntityPlayer entityplayer) {
        this.worldObj.playSoundAtEntity(this, "morecreeps:hotdogeat", 1.0F, (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F + 1.0F);
        this.used = true;
        this.health += 10;
        ...
        if (this.tamedcookies > 0) {
            MoreCreepsAndWeirdos.proxy.addChatMessage("You need \2476" + this.tamedcookies + " cookie" + s + " \247fto tame this speedy Zebra.");
        }
        ...
        if (this.tamedcookies == 0) {
            ...
            this.worldObj.playSoundAtEntity(this, "morecreeps:ggpiglevelup", 1.0F, (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F + 1.0F);
    ...
    private void handleOtherInteractions(EntityPlayer entityplayer, ItemStack itemstack) {
        ...
        if (!this.used && !this.tamed) {
            MoreCreepsAndWeirdos.proxy.addChatMessage("You need \2476" + this.tamedcookies + " cookie" + s1 + " \247fto tame this speedy Zebra.");
        }
    ...
    private void unlockZebraAchievement(EntityPlayer entityplayer) {
        // todo fix crash
        if (this.world.isRemote && (!Minecraft.getMinecraft().thePlayer.getStatFileWriter().hasAchievementUnlocked(MoreCreepsAndWeirdos.achievezebra))) {
            this.confetti();
        ...
        if (!this.world.isRemote && (!this.playermp.func_147099_x().hasAchievementUnlocked(MoreCreepsAndWeirdos.achievezebra))) {
            this.confetti();
            this.worldObj.playSoundAtEntity(entityplayer, "morecreeps:achievement", 1.0F, 1.0F);

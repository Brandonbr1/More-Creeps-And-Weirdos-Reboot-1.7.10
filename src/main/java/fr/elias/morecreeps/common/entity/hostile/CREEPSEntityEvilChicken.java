...
public class CREEPSEntityEvilChicken extends EntityMob {
    ...
    public void onLivingUpdate() {
        if (this.isDead || this.worldObj == null) return;
    ...
    public boolean attackEntityFrom(DamageSource damagesource, float i) {
        ...
        if (super.attackEntityFrom(DamageSource.causeMobDamage(this), i)) {
            if (attacker != null) {
                if (this.riddenByEntity == attacker || this.ridingEntity == attacker) return true;

                if (attacker != this && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL

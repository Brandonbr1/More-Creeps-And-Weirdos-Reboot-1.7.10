...
public class CREEPSEntityDigBug extends EntityMob {
    ...
    public void onLivingUpdate() {
        ...
        if (this.prevPosX != this.posX || this.prevPosY != this.posY) {
            this.texture = "morecreeps:textures/entity/digbug" +
                    this.skinframe +
                    ".png";
            this.skinframe++;
        ...
        if (this.digstage == 1) {
            ...
            if (this.digtimer-- < 1) {
                this.digtimer = this.rand.nextInt(20);
                this.setPosition((int) (this.holeX + this.xx), (int) (this.holeY - this.yy), (int) (this.holeZ + this.zz));
                Block i3 = this.worldObj.getBlock((int) (this.holeX + this.xx), (int) (this.holeY - this.yy), (int) (this.holeZ + this.zz));
                ...
                this.worldObj.setBlockToAir((int) (this.holeX + this.xx), (int) (this.holeY - this.yy), (int) (this.holeZ + this.zz));
                    ...
                    if (this.xx++ > 1.0D) {
                        ...
                        if (this.yy++ > this.holedepth) {
                            for (int k3 = 0; k3 < this.rand.nextInt(8) + 5; k3++) {
                                ...
                                CREEPSEntityBubbleScum creepsentitybubblescum = new CREEPSEntityBubbleScum(this.worldObj);
                            ...
                            this.digstage = 2;
                            double moveSpeed = this.getEntityAttribute(SharedMonsterAttributes.movementSpeed)
                                    .getAttributeValue();
                            moveSpeed = 0.0D;
                            this.lifespan = 5000;
                            this.motionY = 0.44999998807907104D;
                            this.setPosition((int) (this.holeX + 1.0D), (int) (this.holeY - this.yy), (int) (this.holeZ + 1.0D));
        ...
        if (this.digstage == 4) {
            ...
            if (this.digtimer-- < 1) {
                ...
                if (this.worldObj.getBlock((int) (this.holeX + this.xx), (int) (this.holeY - this.yy), (int) (this.holeZ + this.zz)) == Blocks.air) {
                    this.worldObj.setBlock((int) (this.holeX + this.xx), (int) (this.holeY - this.yy), (int) (this.holeZ + this.zz), Blocks.dirt);
                }

                if (this.zz++ > 2D) {
                    this.zz = -1D;
                    this.setPosition((int) (this.holeX + this.xx), (int) (this.holeY - this.yy) + 1, (int) (this.holeZ + this.zz));
                    ...
                    if (this.xx++ > 2D) {
                        ...
                        if (this.yy-- == 1.0D) {
                            ...
                            this.setPosition((int) (this.holeX + 1.0D), (int) (this.holeY + this.yy + 1.0D), (int) (this.holeZ + 1.0D));
                        }
                    }
                }
            }
    ...
    public boolean isEntityInsideOpaqueBlock() {
        if (this.digstage == 1 || this.digstage == 4)
            return false;
        else
    ...
    protected void attackEntity(Entity entity, float f) {
        if (entity.getBoundingBox() != null && this.getBoundingBox() != null) {
            ...
            this.motionZ = (d1 / f1) * 0.40000000000000002D * 0.070000001920928964D + this.motionZ * 0.18000000098023225D;

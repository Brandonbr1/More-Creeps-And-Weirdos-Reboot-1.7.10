...
public class CREEPSEntityBullet extends Entity implements IProjectile {
    ...
    public CREEPSEntityBullet(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_,
    ...
    public CREEPSEntityBullet(World world, EntityLivingBase p_i1756_2_, float p_i1756_3_) {
        ...
        if (Math.abs(p_i1756_2_.motionX) > 0.10000000000000001D || Math.abs(p_i1756_2_.motionY) > 0.10000000000000001D

...
public class CREEPSEntityBullet extends Entity implements IProjectile {
  ...
  public CREEPSEntityBullet(World p_i1753_1_) {
    super(p_i1753_1_);
  ...
  public CREEPSEntityBullet(
      World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_) {
    super(p_i1754_1_);
    this.renderDistanceWeight = 10.0D;
  ...
  public CREEPSEntityBullet(World world, EntityLivingBase p_i1756_2_, float p_i1756_3_) {
    super(world);
    this.renderDistanceWeight = 10.0D;
    ...
    if (p_i1756_2_ instanceof CREEPSEntityArmyGuy) {
      this.damage = 1;
    }

    if ((p_i1756_2_ instanceof CREEPSEntityArmyGuy) && ((CREEPSEntityArmyGuy) p_i1756_2_).loyal) {
      this.damage = 5;
    }

    if (p_i1756_2_ instanceof CREEPSEntitySneakySal) {
    ...
    if (Math.abs(p_i1756_2_.motionX) > 0.10000000000000001D
        || Math.abs(p_i1756_2_.motionY) > 0.10000000000000001D
        || Math.abs(p_i1756_2_.motionZ) > 0.10000000000000001D) {
      f1 *= 2.0F;
    }

    if (p_i1756_2_.onGround) {;
    }
  ...
  public void setThrowableHeading(
    ...
    float f2 =
        MathHelper.sqrt_double(
            p_70186_1_ * p_70186_1_ + p_70186_3_ * p_70186_3_ + p_70186_5_ * p_70186_5_);
    p_70186_1_ /= f2;
    p_70186_3_ /= f2;
    p_70186_5_ /= f2;
    p_70186_1_ +=
    ...
    this.prevRotationYaw =
        this.rotationYaw = (float) (Math.atan2(p_70186_1_, p_70186_5_) * 180.0D / Math.PI);
    this.prevRotationPitch =
        this.rotationPitch = (float) (Math.atan2(p_70186_3_, f3) * 180.0D / Math.PI);
  }

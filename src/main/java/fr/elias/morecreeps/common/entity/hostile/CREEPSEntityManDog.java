...
public class CREEPSEntityManDog extends EntityMob {
    ...
    public void onUpdate() {
        ...
        if (this.tamed) {
            ...
            if (this.chase) {
                ...
                if (Math.abs(this.frisbeeent.posX - this.posX) < 1.0D && Math.abs(this.frisbeeent.posY - this.posY) < 1.0D
                ...
                this.motionX = (d / f) * 0.40000000000000002D * 0.50000000192092897D
                        + this.motionX * 0.18000000098023225D;
                this.motionZ = (d2 / f) * 0.40000000000000002D * 0.40000000192092894D
                ...
                if (Math.abs(this.frisbeeent.posX - this.posX) < 5D && Math.abs(this.frisbeeent.posZ - this.posZ) < 5D
            ...
            if (this.fetch && this.frisbeeent != null) {
                if (Math.abs(this.frisbeeent.posX - this.posX) < 2D && Math.abs(this.frisbeeent.posY - this.posY) < 2D
                ...
                this.motionX = (d1 / f1) * 0.40000000000000002D * 0.50000000192092897D
                        + this.motionX * 0.18000000098023225D;
                this.motionZ = (d3 / f1) * 0.40000000000000002D * 0.40000000192092894D
                        + this.motionZ * 0.18000000098023225D;
    ...
    protected void attackEntity(Entity entity, float f) {
        ...
        this.motionX = (d / f1) * 0.40000000000000002D * 0.30000000192092896D + this.motionX * 0.18000000098023225D;
        this.motionZ = (d1 / f1) * 0.40000000000000002D * 0.44000000192092897D + this.motionZ * 0.18000000098023225D;
    }
    ...
    class AIAttackEntity extends EntityAIBase {
        ...
        public void updateTask() {
            try {
                float f = CREEPSEntityManDog.this.getDistanceToEntity(CREEPSEntityManDog.this.getAttackTarget());
                if (f < 256F) {
                    CREEPSEntityManDog.this.attackEntity(CREEPSEntityManDog.this.getAttackTarget(), f);
                    CREEPSEntityManDog.this.getLookHelper()
                    .setLookPositionWithEntity(CREEPSEntityManDog.this.entityToAttack, 10.0F, 10.0F);
                    CREEPSEntityManDog.this.getNavigator()
                    .clearPathEntity();
                    CREEPSEntityManDog.this.getMoveHelper()
                    .setMoveTo(

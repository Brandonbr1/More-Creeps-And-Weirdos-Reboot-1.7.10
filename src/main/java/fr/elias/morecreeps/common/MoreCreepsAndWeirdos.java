...
import fr.elias.morecreeps.common.entity.hostile.CREEPSEntityEvilEgg;
...
public class MoreCreepsAndWeirdos {
    ...
    <<<<<<< HEAD
    // BELOW : This particle system of Minecraft... -_-
    public static Item partBubble,
    partWhite,
    partRed,
    partBlack,
    partYellow,
    ...
    >>>>>>> master
    public static CreativeTabs creepsTab =
    new CreativeTabs("creepsTab") {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        packetHandler.registerMessage(
                SyncPlayerDataPacket.Handler.class, SyncPlayerDataPacket.class, 1, Side.CLIENT);
        packetHandler.registerMessage(
                <<<<<<< HEAD
                SetGiraffeNamePacket.Handler.class, SetGiraffeNamePacket.class, 2, Side.SERVER);
        packetHandler.registerMessage(
                MountInputPacket.Handler.class, MountInputPacket.class, 3, Side.SERVER);
        =======
                MountInputPacket.Handler.class, MountInputPacket.class, 2, Side.SERVER);
                packetHandler.registerMessage(
                        TameableNamePacket.Handler.class, TameableNamePacket.class, 3, Side.SERVER);
                >>>>>>> master

                MoreCreepsAndWeirdos.gemSwordMaterial =
                EnumHelper.addToolMaterial(
                        Reference.MOD_ID + "GemToolMaterial", 3, 1561, 55.0F, CREEPSConfig.gemSwordDam - 4, 10);

                partBubble = new Item().setUnlocalizedName("partBubble").setTextureName("morecreeps:bubble");
                partWhite = new Item().setUnlocalizedName("partWhite").setTextureName("morecreeps:White");
                partRed = new Item().setUnlocalizedName("partRed").setTextureName("morecreeps:Red");
                partBlack = new Item().setUnlocalizedName("partBlack").setTextureName("morecreeps:Black");
                partYellow = new Item().setUnlocalizedName("partYellow").setTextureName("morecreeps:Yellow");
                partBlue = new Item().setUnlocalizedName("partBlue").setTextureName("morecreeps:Blue");
                partShrink = new Item().setUnlocalizedName("partShrink").setTextureName("morecreeps:Shrink");
                partBarf = new Item().setUnlocalizedName("partBarf").setTextureName("morecreeps:partBarf");
                ...
                zebrahelmet =
                        (new CREEPSItemArmorZebra(zebraARMOR, 5, 0))
                        .setUnlocalizedName("zebraHelmet")
                        .setTextureName("morecreeps:zebraHelmet");
                zebrabody =
                        (new CREEPSItemArmorZebra(zebraARMOR, 5, 1))
                        .setUnlocalizedName("zebraBody")
                        .setTextureName("morecreeps:zebraBody");
                zebralegs =
                        new CREEPSItemArmorZebra(zebraARMOR, 5, 2)
                        .setUnlocalizedName("zebraLegs")
                        .setTextureName("morecreeps:zebralegs");
                zebraboots =
                        (new CREEPSItemArmorZebra(zebraARMOR, 5, 3))
                        .setUnlocalizedName("zebraBoots")
                ...
                a_pyramid =
                        new Item().setUnlocalizedName("morecreeps:a_pyramid").setTextureName("morecreeps:pyramid");
                a_floob =
                        new Item().setUnlocalizedName("morecreeps:a_floob").setTextureName("morecreeps:floob");
                a_rockmonster =
                        new Item()
                        .setUnlocalizedName("morecreeps:a_rockmonster")
                        .setTextureName("morecreeps:rockmonster");
                a_bubble =
                        new Item().setUnlocalizedName("morecreeps:a_bubble").setTextureName("morecreeps:bubble");
                a_hotdog =
                        new Item().setUnlocalizedName("morecreeps:a_hotdog").setTextureName("morecreeps:hotdog");
                a_camel =
                        new Item().setUnlocalizedName("morecreeps:a_camel").setTextureName("morecreeps:camel");
                a_zebra =
                        new Item().setUnlocalizedName("morecreeps:a_zebra").setTextureName("morecreeps:zebra");
                a_nonswimmer =
                        new Item()
                        .setUnlocalizedName("morecreeps:a_nonswimmer")
                        .setTextureName("morecreeps:nonswimmer");
                a_caveman =
                        new Item().setUnlocalizedName("morecreeps:a_caveman").setTextureName("morecreeps:caveman");
                placer =
                        new CREEPSItemSpawner()
                ...
                GameRegistry.registerItem(placer, "Spawn");

                blorpcola =
                        new CREEPSItemBlorpCola()
                        .setCreativeTab(creepsTab)
                        .setUnlocalizedName("blorpCola")
                        .setTextureName("morecreeps:blorpCola");
                bandaid =
                        new CREEPSItemBandAid()
                        .setCreativeTab(creepsTab)
                        .setUnlocalizedName("bandAid")
                        .setTextureName("morecreeps:bandAid");
                goodonut =
                        new CREEPSItemGooDonut()
                        .setCreativeTab(creepsTab)
                ...
                achievechugcola =
                        (new Achievement("chugcola", "chugcola", aX + 2, aY, blorpcola, null)).registerStat();
                achieveradio =
                        (new Achievement("guineapigradio", "guineapigradio", aX + 4, aY, guineapigradio, null))
                        .registerStat();
                achievepyramid =
                        (new Achievement("pyramid", "pyramid", aX + 6, aY, a_pyramid, null)).registerStat();
                achievelolliman =
                        (new Achievement("lolliman", "lolliman", aX + 8, aY, lolly, null)).registerStat();
                achievesnowdevil =
                        (new Achievement("snowdevil", "snowdevil", aX + 2, aY + 2, Blocks.ice, null))
                        .registerStat();
                achievehunchback =
                        (new Achievement("hunchback", "hunchback", aX + 4, aY + 2, Items.cake, null))
                        .registerStat();
                achievecamel =
                        <<<<<<< HEAD
                        (new Achievement("camel", "camel", aX + 6, aY + 2, a_camel, achievecamel)).registerStat();
                achievezebra =
                        (new Achievement("zebra", "zebra", aX + 8, aY + 2, a_zebra, achievezebra)).registerStat();
                =======
                        (new Achievement("camel", "camel", aX + 6, aY + 2, a_camel, null)).registerStat();
                achievezebra =
                        (new Achievement("zebra", "zebra", aX + 8, aY + 2, a_zebra, null)).registerStat();
                >>>>>>> master
                        achieverockmonster =
                        (new Achievement("rockmonster", "rockmonster", aX, aY + 2, a_rockmonster, null))
                        .registerStat();
                achieveschlump =
                        <<<<<<< HEAD
                        (new Achievement("schlump", "schlump", aX, aY + 4, babyjarfull, achieveschlump))
                        .registerStat();
                =======
                        (new Achievement("schlump", "schlump", aX, aY + 4, babyjarfull, null)).registerStat();
                >>>>>>> master
                        achievenonswimmer =
                        (new Achievement(
                                "nonswimmer", "nonswimmer", aX + 2, aY + 4, a_nonswimmer, achievenonswimmer))
                        .registerStat();
                achievepigtaming =
                        (new Achievement("pigtaming", "pigtaming", aX, aY + 6, a_pig, null)).registerStat();
                achievepiglevel5 =
                        (new Achievement("level5", "level5", aX + 2, aY + 6, a_pig, achievepigtaming))
                        .registerStat();
                achievepiglevel10 =
                        (new Achievement("level10", "level10", aX + 4, aY + 6, a_pig, achievepiglevel5))
                        .registerStat();
                achievepiglevel20 =
                        (new Achievement("level20", "level20", aX + 6, aY + 6, a_pig, achievepiglevel10))
                        .registerStat();
                achievepighotel =
                        (new Achievement("pighotel", "pighotel", aX + 8, aY + 6, a_pig, achievepiglevel20))
                        .registerStat();
                achieverocketgiraffe =
                        (new Achievement("rocketgiraffe", "rocketgiraffe", aX, aY + 8, rocket, null))
                        .registerStat();
                achieverocket =
                        (new Achievement("rocket", "rocket", aX + 2, aY + 8, rocket, achieverocketgiraffe))
                        .registerStat();
                achieverocketrampage =
                        (new Achievement("rocketrampage", "rocketrampage", aX + 4, aY + 8, rocket, achieverocket))
                        .registerStat();
                achievefloobkill =
                        (new Achievement("floobkill", "floobkill", aX, aY + 10, a_floob, null)).registerStat();
                achievefloobicide =
                        (new Achievement("floobicide", "floobicide", aX + 2, aY + 10, a_floob, achievefloobkill))
                        .registerStat();
                achievegookill =
                        (new Achievement("gookill", "gookill", aX, aY + 12, goodonut, null)).registerStat();
                achievegookill10 =
                        (new Achievement("gookill10", "gookill10", aX + 2, aY + 12, goodonut, achievegookill))
                        .registerStat();
                achievegookill25 =
                        (new Achievement("gookill25", "gookill25", aX + 4, aY + 12, goodonut, achievegookill10))
                        .registerStat();
                achievebumflower =
                        (new Achievement("bumflower", "bumflower", aX, aY + 14, Blocks.yellow_flower, null))
                        .registerStat();
                achievebumpot =
                        (new Achievement("bumpot", "bumpot", aX + 2, aY + 14, Items.bucket, achievebumflower))
                        .registerStat();
                achievebumlava =
                        (new Achievement("bumlava", "bumlava", aX + 4, aY + 14, Items.lava_bucket, achievebumpot))
                        .registerStat();
                achieve100bucks =
                        (new Achievement("achieve100bucks", "achieve100bucks", aX, aY + 16, money, null))
                        .registerStat();
                achieve500bucks =
                        (new Achievement(
                                "achieve500bucks", "achieve500bucks", aX + 2, aY + 16, money, achieve100bucks))
                        .registerStat();
                achieve1000bucks =
                        (new Achievement(
                                "achieve1000bucks", "achieve1000bucks", aX + 4, aY + 16, money, achieve500bucks))
                        .registerStat();
                achieve10bubble =
                        (new Achievement("achieve10bubble", "achieve10bubble", aX, aY + 18, a_bubble, null))
                        .registerStat();
                achieve25bubble =
                        (new Achievement(
                                "achieve25bubble", "achieve25bubble", aX + 2, aY + 18, a_bubble, achieve10bubble))
                        .registerStat();
                achieve50bubble =
                        (new Achievement(
                                "achieve50bubble", "achieve50bubble", aX + 4, aY + 18, a_bubble, achieve25bubble))
                        .registerStat();
                achieve100bubble =
                        (new Achievement(
                                "achieve100bubble", "achieve100bubble", aX + 6, aY + 18, a_bubble, achieve50bubble))
                        .registerStat();
                achievesnow =
                        (new Achievement("achievesnow", "achievesnow", aX, aY + 20, Items.snowball, null))
                        .registerStat();
                achievesnowtiny =
                        (new Achievement(
                                "achievesnowtiny", "achievesnowtiny", aX + 2, aY + 20, Items.snowball, null))
                        .registerStat();
                achievesnowtall =
                        (new Achievement(
                                "achievesnowtall", "achievesnowtall", aX + 4, aY + 20, Items.snowball, null))
                        .registerStat();
                achievehotdogtaming =
                        (new Achievement("hotdogtaming", "hotdogtaming", aX, aY + 22, a_hotdog, null))
                        .registerStat();
                achievehotdoglevel5 =
                        (new Achievement("hotdoglevel5", "level5", aX + 2, aY + 22, a_hotdog, achievehotdogtaming))
                        .registerStat();
                achievehotdoglevel10 =
                        (new Achievement(
                                "hotdoglevel10", "level10", aX + 4, aY + 22, a_hotdog, achievehotdoglevel5))
                        .registerStat();
                achievehotdoglevel25 =
                        (new Achievement(
                                "hotdoglevel25", "level25", aX + 6, aY + 22, a_hotdog, achievehotdoglevel10))
                        .registerStat();
                achievehotdogheaven =
                        (new Achievement(
                                "hotdogheaven", "hotdogheaven", aX + 8, aY + 22, a_hotdog, achievehotdoglevel25))
                        .registerStat();
                achieveram128 = (new Achievement("ram128", "ram128", aX, aY + 24, ram16k, null)).registerStat();
                achieveram512 =
                        (new Achievement("ram512", "ram512", aX + 2, aY + 24, ram16k, achieveram128))
                        .registerStat();
                achieveram1024 =
                        (new Achievement("ram1024", "ram1024", aX + 4, aY + 24, ram16k, achieveram512))
                        .registerStat();
                achievegotohell =
                        (new Achievement("gotohell", "gotohell", aX, aY + 26, a_hell, null)).registerStat();
                achievefalseidol =
                        (new Achievement("falseidol", "falseidol", aX + 2, aY + 26, a_hell, achievegotohell))
                        .registerStat();
                achieveprisoner =
                        (new Achievement("achieveprisoner", "achieveprisoner", aX, aY + 28, Blocks.iron_bars, null))
                        .registerStat();
                achieve5prisoner =
                        (new Achievement(
                                "achieve5prisoner",
                ...
                achieve10prisoner =
                        ...
                        .registerStat();
                achieve1caveman =
                        (new Achievement("achieve1caveman", "achieve1caveman", aX, aY + 30, a_caveman, null))
                        .registerStat();
                achieve10caveman =
                        (new Achievement(
                                "achieve10caveman",
    ...
    public void init(FMLInitializationEvent event) {
        ...
        EntityRegistry.registerModEntity(
                ...
                true);
        EntityRegistry.registerModEntity(
                CREEPSEntityRay.class, "RayEnt", CREEPSConfig.ray_projectile_ID, this, 40, 1, true);
        EntityRegistry.registerModEntity(
                CREEPSEntityMoney.class, "MoneyEnt", CREEPSConfig.money_projectile_ID, this, 40, 1, true);
        EntityRegistry.registerModEntity(
                ...
                true);
        EntityRegistry.registerModEntity(
                CREEPSEntityGrow.class, "GrowEnt", CREEPSConfig.grow_projectile_ID, this, 40, 1, true);
        EntityRegistry.registerModEntity(
        ...
        EntityRegistry.registerModEntity(
                ...
                true);
        EntityRegistry.registerModEntity(
                CREEPSEntityEvilEgg.class, "Evilegg", 453467, this, 40, 1, true);
        EntityRegistry.registerModEntity(
                CREEPSEntityFoam.class, "FoamEnt", CREEPSConfig.foam_projectile_ID, this, 40, 1, true);
        EntityRegistry.registerModEntity(
    ...
    public void addMob(
            Class<? extends EntityLiving> classz,
            String name,
            int id,
            int weightedProb,
            int min,

...
public class MoreCreepsAndWeirdos {
    ...
    public static Item partBubble, partWhite, partRed, partBlack, partYellow, partBlue, partShrink, partBarf, placer;
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        placer = new CREEPSItemSpawner().setUnlocalizedName("monsterPlacer").setTextureName("minecraft:spawn_egg");
    ...
    public void init(FMLInitializationEvent event) {
        ...
        this.addMob(CREEPSEntityCastleKing.class, "CastleKing", 3537, 1, 1, 1, EnumCreatureType.monster, this.allBiomes());
        this.addMob(CREEPSEntityEvilChicken.class, "EvilChicken", 3531, 1, 1, 1, EnumCreatureType.monster, this.allBiomes());
        this.addMob(CREEPSEntityPyramidGuardian.class, "PyramidGuardian", 3532, 1, 1, 1, EnumCreatureType.monster, this.allBiomes());
        this.addMob(CREEPSEntityEvilCreature.class, "EntityEvilCreature", 3533, 1, 1, 1, EnumCreatureType.monster, this.allBiomes());
        this.addMob(CREEPSEntityCastleCritter.class, "CastleCritter", 3534, 1, 1, 1, EnumCreatureType.monster, this.allBiomes());
        this.addMob(CREEPSEntityEvilPig.class, "EvilPig", 3535, 1, 1, 1, EnumCreatureType.monster, this.allBiomes());
        this.addMob(CREEPSEntityCastleGuard.class, "CastleGuard", 3536, 1, 1, 1, EnumCreatureType.monster, this.allBiomes());
        this.addMob(CREEPSEntityTowel.class, "TowelEntity", 6432, 1, 1, 1, EnumCreatureType.monster, this.allBiomes());
        this.addMob(CREEPSEntityEvilSnowman.class, "EvilSnowMan", 3538, 1, 1, 1, EnumCreatureType.monster, this.allBiomes());
        this.addMob(CREEPSEntityEvilLight.class, "EvilLight", 567853, 0, 0, 0, EnumCreatureType.ambient, this.allBiomes());
        proxy.render();

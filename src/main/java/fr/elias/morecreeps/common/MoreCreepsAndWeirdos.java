...
public class MoreCreepsAndWeirdos {
    ...
    public static Item blorpcola, bandaid, goodonut, money, raygun, shrinkray, shrinkshrink, limbs, babyjarempty,
        ...
        earthgem, mininggem, healinggem, skygem, gemsword, moopsworm, cavemanclub, popsicle, placer;
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        packetHandler.registerMessage(MountInputPacket.Handler.class, MountInputPacket.class, 2, Side.SERVER);
        packetHandler.registerMessage(TameableNamePacket.Handler.class, TameableNamePacket.class, 3, Side.SERVER);

        MoreCreepsAndWeirdos.gemSwordMaterial = EnumHelper
            .addToolMaterial(Reference.MOD_ID + "GemToolMaterial", 3, 1561, 55.0F, CREEPSConfig.gemSwordDam - 4, 10);
        ...
        placer = new CREEPSItemSpawner().setUnlocalizedName("monsterPlacer")
        ...
        achievecamel = (new Achievement("camel", "camel", aX + 6, aY + 2, a_camel, null)).registerStat();
        achievezebra = (new Achievement("zebra", "zebra", aX + 8, aY + 2, a_zebra, null)).registerStat();
        achieverockmonster = (new Achievement("rockmonster", "rockmonster", aX, aY + 2, a_rockmonster, null))
            .registerStat();
        achieveschlump = (new Achievement("schlump", "schlump", aX, aY + 4, babyjarfull, null)).registerStat();

...
public class ClientProxy extends CommonProxy {
    ...
    public void render() {
        ...
        RenderingRegistry
            .registerEntityRenderingHandler(CREEPSEntityMummy.class, new CREEPSRenderMummy(new ModelBiped(), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(
        ...
        RenderingRegistry.registerEntityRenderingHandler(
            ...
            new CREEPSRenderPrisoner(new ModelBiped(), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(
        ...
        RenderingRegistry.registerEntityRenderingHandler(
            ...
            new CREEPSRenderInvisibleMan(new ModelBiped(), 0.5F));
    }
    ...
    @Override
    public void spawnLollimanConfetti(World world, Entity entity, Random rand, int iterAmm1, int iterAmm2) {
        // 20 for lolli man
    ...
    public void shrinkBlast(World world, Entity entity, Random rand) {
        if (world.isRemote && entity != null) {
            for (int i = 0; i < 8; i++) {
                ...
                CREEPSFxSmoke creepsfxsmoke = new CREEPSFxSmoke(world, entity.posX, entity.posY, entity.posZ, 0.5F, 0);
                Minecraft.getMinecraft().effectRenderer.addEffect(creepsfxsmoke);
            }
        }
    }
    ...
    public void shrinkSmoke(World world, Entity entity) {
        if (world != null && world.isRemote && entity != null) {
            for (int k = 0; k < 8; k++) {
                CREEPSFxSmoke creepsfxsmoke = new CREEPSFxSmoke(world, entity.posX, entity.posY, entity.posZ, 0.25F, 0);
    ...
    public void smoke2(World world, Entity entity, Random random) {
        if (!world.isRemote) return;
        for (int i = 0; i < 8; i++) {
            CREEPSFxSmoke creepsfxsmoke = new CREEPSFxSmoke(world, entity.posX, entity.posY, entity.posZ, 0.2F, 0.5F);
            Minecraft.getMinecraft().effectRenderer.addEffect(creepsfxsmoke);
        }
    }
    ...
    public void growParticle(World world, Entity entity) {
        if (!world.isRemote) return;
        for (int k = 0; k < 8; k++) {
            CREEPSFxSmoke creepsfxsmoke = new CREEPSFxSmoke(world, entity.posX, entity.posY, entity.posZ, 0.25F, 0.0F);
            Minecraft.getMinecraft().effectRenderer.addEffect(creepsfxsmoke);
        }
    }
    ...
    public void smokeRay(World world, Entity entity, byte b0) {
        if (!world.isRemote) return;
        CREEPSFxSmoke creepsfxsmoke = new CREEPSFxSmoke(world, entity.posX, entity.posY, entity.posZ, b0, 0.5F);
        Minecraft.getMinecraft().effectRenderer.addEffect(creepsfxsmoke);
    }
    ...
    public void shrinkParticle(World world, Entity entity) {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            CREEPSFxSmoke creepsfxsmoke = new CREEPSFxSmoke(world, entity.posX, entity.posY, entity.posZ, 0.5F, 0.0F);
            Minecraft.getMinecraft().effectRenderer.addEffect(creepsfxsmoke);
        }
    }
    ...
    public void addChatMessage(World world, String s) {
        if (world.isRemote && Minecraft.getMinecraft() != null && Minecraft.getMinecraft().thePlayer != null) {

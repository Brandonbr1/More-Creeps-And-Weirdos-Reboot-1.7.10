...
public class CREEPSRenderEvilChicken extends RenderLiving {
    ...
    protected void fattenup(CREEPSEntityEvilChicken creepsentityevilchicken, float f) {
        GL11.glScalef(
            creepsentityevilchicken.modelsize,
            creepsentityevilchicken.modelsize,
            creepsentityevilchicken.modelsize);
    }

    protected float func_180569_a(CREEPSEntityEvilChicken creepsentityevilchicken, float f) {
        float f1 = creepsentityevilchicken.field_756_e
            + (creepsentityevilchicken.field_752_b - creepsentityevilchicken.field_756_e) * f;
        float f2 = creepsentityevilchicken.field_757_d
            + (creepsentityevilchicken.destPos - creepsentityevilchicken.field_757_d) * f;

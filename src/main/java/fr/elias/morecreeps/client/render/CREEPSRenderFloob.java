...
public class CREEPSRenderFloob extends RenderLiving {
  ...
  public CREEPSRenderFloob(CREEPSModelFloob creepsmodelfloob, float f) {
    ...
    this.modelFloobMain = creepsmodelfloob;
  }
  ...
  protected void preRenderCallback(EntityLivingBase entityliving, float f) {
    this.fattenup((CREEPSEntityFloob) entityliving, f);
  }
  ...
  protected ResourceLocation getEntityTexture(Entity entity) {
    ...
    return this.getEntityTexture((CREEPSEntityFloob) entity);
  }
  ...
  protected void renderEquippedItems(EntityLiving p_77029_1_, float p_77029_2_) {
    ...
    if (itemstack1 != null) {
      GL11.glPushMatrix();
      this.modelFloobMain.bipedHead.postRender(0.0625F);
    ...
    if (itemstack != null && itemstack.getItem() != null) {
      ...
      this.modelFloobMain.bipedRightArm.postRender(0.0625F);
  ...
  protected void renderEquippedItems(EntityLivingBase p_77029_1_, float p_77029_2_) {
    this.renderEquippedItems((CREEPSEntityFloob) p_77029_1_, p_77029_2_);
  }
}

...
public class CREEPSRenderBlackSoul extends RenderLiving {
  ...
  public static ResourceLocation layer_texture =
      new ResourceLocation("morecreeps:textures/entity/blacksoulglow.png");
  public CREEPSRenderBlackSoul blackSoulRender;
  ResourceLocation eyeglow =
      new ResourceLocation(
          Reference.MOD_ID, Reference.TEXTURE_PATH_ENTITES + Reference.TEXTURE_BLACK_SOUL_EYES);

  public CREEPSRenderBlackSoul(ModelBiped modelbiped, float f) {
    super(new ModelBiped(), 1.0F);
  }

  public void doRenderLayerBlackSoul(
      CREEPSEntityBlackSoul p_177141_1_,
      float p_177141_2_,
      float p_177141_3_,
      float p_177141_4_,
      float p_177141_5_,
    ...
    OpenGlHelper.setLightmapTextureCoords(
        OpenGlHelper.lightmapTexUnit, (float) i / 1.0F, (float) j / 1.0F);
    GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
    // this.blackSoulRender.getMainModel().render(p_177141_1_, p_177141_2_, p_177141_3_,
    // p_177141_5_, p_177141_6_,
  ...
  protected void fattenup(CREEPSEntityBlackSoul creepsentityblacksoul, float f) {
    GL11.glScalef(
        creepsentityblacksoul.modelsize,
        creepsentityblacksoul.modelsize,
        creepsentityblacksoul.modelsize);
  }

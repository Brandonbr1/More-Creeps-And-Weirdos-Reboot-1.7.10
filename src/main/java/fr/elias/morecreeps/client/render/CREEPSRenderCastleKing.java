...
public class CREEPSRenderCastleKing extends RenderLiving {
    ...
    protected void renderEquippedItems(EntityLiving p_77029_1_, float p_77029_2_) {
        ...
        if (itemstack1 != null) {
            GL11.glPushMatrix();
            this.modelcastlekingmain.bipedHead.postRender(0.0625F);
        ...
        if (itemstack != null && itemstack.getItem() != null) {
            ...
            this.modelcastlekingmain.bipedRightArm.postRender(0.0625F);
    ...
    protected void renderEquippedItems(EntityLivingBase p_77029_1_, float p_77029_2_) {
        this.renderEquippedItems((CREEPSEntityCastleKing) p_77029_1_, p_77029_2_);
    }
}

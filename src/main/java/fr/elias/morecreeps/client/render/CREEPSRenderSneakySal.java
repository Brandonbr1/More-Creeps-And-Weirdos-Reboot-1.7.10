...
public class CREEPSRenderSneakySal extends RenderLiving {
    ...
    public CREEPSRenderSneakySal(CREEPSModelSneakySal creepsmodelsneakysal, float f) {
        ...
        this.modelBipedMain = creepsmodelsneakysal;
    }

    protected void fattenup(CREEPSEntitySneakySal creepsentitysneakysal, float f) {
        GL11.glScalef(
                creepsentitysneakysal.modelsize,
                creepsentitysneakysal.modelsize + 0.1F,
                creepsentitysneakysal.modelsize);
    }
    ...
    protected void preRenderCallback(EntityLivingBase entityliving, float f) {
        ...
        this.modelBipedMain.shooting = creepsentitysneakysal.shooting;
        this.fattenup((CREEPSEntitySneakySal) entityliving, f);
    }
    ...
    protected ResourceLocation getEntityTexture(Entity entity) {
        ...
        return this.getEntityTexture((CREEPSEntitySneakySal) entity);
    }
    ...
    protected void renderEquippedItems(EntityLiving p_77029_1_, float p_77029_2_) {
        ...
        if (itemstack1 != null) {
            GL11.glPushMatrix();
            this.modelBipedMain.tonyHead.postRender(0.0625F);
    ...
    protected void renderEquippedItems(EntityLivingBase p_77029_1_, float p_77029_2_) {
        this.renderEquippedItems((CREEPSEntitySneakySal)p_77029_1_, p_77029_2_);
    }
}

...
public class CREEPSRenderHotdog extends RenderLiving {
    ...
    public void doRenderLiving(EntityLiving entityliving, double d, double d1, double d2, float f, float f1) {
        ...
        s = (new StringBuilder()).append(s)
            .append(((CREEPSEntityHotdog) entityliving).name)
            .toString();
        String s1 = String.valueOf(((CREEPSEntityHotdog) entityliving).level);

        if (((CREEPSEntityHotdog) entityliving).getHealth() < ((CREEPSEntityHotdog) entityliving).getMaxHealth() / 2
            && s.length() > 0) {
            s = (new StringBuilder()).append(s)
                .append(" \247c * WOUNDED *")
                .toString();
    ...
    public void burnDog(Entity entity, double d, double d1, double d2, float f) {
        ...
        Minecraft.getMinecraft()
            ...
            .bindTexture(
                Minecraft.getMinecraft()
                    .getTextureMapBlocks().locationBlocksTexture);
        Tessellator tessellator = Tessellator.instance;
        float f6 = 1.0F;
        float f7 = 0.5F;
        float f8 = -0.75F;

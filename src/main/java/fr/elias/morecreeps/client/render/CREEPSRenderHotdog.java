...
public class CREEPSRenderHotdog extends RenderLiving {
  ...
  public void doRenderLiving(
    ...
    if (((CREEPSEntityHotdog) entityliving).getHealth()
            < ((CREEPSEntityHotdog) entityliving).getMaxHealth() / 2
        && s.length() > 0) {
  ...
  protected void fattenup(CREEPSEntityHotdog creepsentityhotdog, float f) {
    GL11.glScalef(
        creepsentityhotdog.dogsize, creepsentityhotdog.dogsize, creepsentityhotdog.dogsize + 0.25F);
  }

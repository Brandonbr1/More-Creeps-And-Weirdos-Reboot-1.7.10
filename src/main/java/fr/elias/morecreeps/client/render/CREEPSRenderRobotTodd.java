...
public class CREEPSRenderRobotTodd extends RenderLiving {
  ...
  public void doRenderTodd(
      CREEPSEntityRobotTodd creepsentityrobottodd,
      double d,
      double d1,
      double d2,
      float f,
    ...
    try {
      float f2 =
          creepsentityrobottodd.prevRenderYawOffset
              + (creepsentityrobottodd.renderYawOffset - creepsentityrobottodd.prevRenderYawOffset)
                  * f1;
      float f3 =
          creepsentityrobottodd.prevRotationYaw
              + (creepsentityrobottodd.rotationYaw - creepsentityrobottodd.prevRotationYaw) * f1;
      float f4 =
          creepsentityrobottodd.prevRotationPitch
              + (creepsentityrobottodd.rotationPitch - creepsentityrobottodd.prevRotationPitch)
                  * f1;

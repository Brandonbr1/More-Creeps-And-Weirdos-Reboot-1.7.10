...
public class CREEPSRenderHunchbackSkeleton extends RenderLiving {
  ...
  protected void preRenderCallback(EntityLivingBase entityliving, float f) {
    this.fattenup((CREEPSEntityHunchbackSkeleton) entityliving, f);
  }
  ...
  protected ResourceLocation getEntityTexture(Entity entity) {
    ...
    return this.getEntityTexture((CREEPSEntityHunchbackSkeleton) entity);
  }
  ...
  protected void renderEquippedItems(EntityLivingBase p_77029_1_, float p_77029_2_) {
    this.renderEquippedItems((CREEPSEntityHunchbackSkeleton) p_77029_1_, p_77029_2_);
  }
}

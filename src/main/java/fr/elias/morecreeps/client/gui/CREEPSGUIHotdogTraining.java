    ...
    protected void actionPerformed(GuiButton guibutton) {
        ...
        if (guibutton.id == 0) {
            Minecraft.getMinecraft()
                .displayGuiScreen(new CREEPSGUIHotdog(hotdog));
        }
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        drawCenteredString(
            ...
            (new StringBuilder()).append("\2476")
                .append(String.valueOf(hotdog.name))
                .append("'s TRAINING")
                .toString(),
            width / 2,
            height / 4 - 40,
        ...
        drawCenteredString(
            fontRendererObj,
            (new StringBuilder()).append("\247fHOTDOG LEVEL : \2473")
        ...
        drawString(
            fontRendererObj,
            buildStat(hotdog.skillattack),
            (width / 2 - 107) + k,
            height / 4 + 38 + byte0,
            0xff8d13);
        drawString(
            fontRendererObj,
            buildStat(hotdog.skilldefend),
            width / 2 + 16 + k,
            height / 4 + 38 + byte0,
            0xff8d13);
        drawString(
            fontRendererObj,
            buildStat(hotdog.skillhealing),
            (width / 2 - 107) + k,
            height / 4 + 95 + byte0,
            0xff8d13);
        drawString(
            fontRendererObj,
            buildStat(hotdog.skillspeed),
            width / 2 + 16 + k,
            height / 4 + 95 + byte0,
            0xff8d13);
        EntityPlayerSP entityplayersp = Minecraft.getMinecraft().thePlayer;
        ...
        drawCenteredString(
            fontRendererObj,
            (new StringBuilder()).append("\247fBONES REMAINING: \2473")
        ...
        drawCenteredString(
            fontRendererObj,
            "\2476Each level costs five bones",
            width / 2 + 2 + k,
            height / 4 + 140 + byte0,
            0xff8d13);

...
public class CREEPSGUIGiraffename extends GuiScreen {
    ...
    protected int xSize;
    protected int ySize;
    public static final ResourceLocation guiTexture = new ResourceLocation("morecreeps:textures/gui/gui-screen.png");
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(1, this.width / 2 - 100, this.height / 4 + 52 + 12, I18n.format("gui.cancel", new Object[0])));
        ...
        if (guibutton.id == 0) { // save
            ...
            if (this.giraffe != null) {
                ...
                if (this.mc != null && this.mc.thePlayer != null) {
                    MoreCreepsAndWeirdos.packetHandler.sendToServer(new SetGiraffeNamePacket(this.giraffe.getEntityId(), s));
                }
            }
            this.mc.displayGuiScreen(null);
        }

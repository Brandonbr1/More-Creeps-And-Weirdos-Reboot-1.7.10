...
public class CREEPSGUIHotdog extends GuiScreen {
    ...
    public void initGui() {
        ...
        byte byte0 = -16;
        buttonList
            .add(new GuiButton(2, width / 2 - 100, height / 4 + 108 + byte0, 98, 20, "\2476XX\247f FIGHT \2476XX"));
        buttonList.add(new GuiButton(3, width / 2 + 2, height / 4 + 108 + byte0, 98, 20, "\2476|| \247f STAY \2476||"));
        buttonList
            .add(new GuiButton(4, width / 2 - 100, height / 4 + 128 + byte0, 98, 20, "\2476<<\247f WANDER \2476>>"));
    ...
    protected void actionPerformed(GuiButton guibutton) {
        ...
        if (guibutton.id == 2) {
            ...
            double moveSpeed = hotdog.getAttributeMap()
        ...
        if (guibutton.id == 5) {
            Minecraft.getMinecraft()
                .displayGuiScreen(new CREEPSGUIHotdogTraining(hotdog));
        }
    }
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        fontRendererObj.drawStringWithShadow(
            (new StringBuilder()).append("\2476LEVEL  \247f")
                .append(String.valueOf(hotdog.level))
                .toString(),
            (width / 2 - 100) + k,
            height / 4 + 28 + byte0,
            0xff8d13);
        drawString(
            fontRendererObj,
            (new StringBuilder()).append("\2476NEXT LVL  \247f")
                .append(String.valueOf((int) hotdog.totaldamage))
                .append("\2473/\247f")
                .append(String.valueOf(CREEPSEntityHotdog.leveldamage[hotdog.level]))
                .toString(),
            (width / 2 + 2 + k) - 10,
            height / 4 + 28 + byte0,
            0xff8d13);
        drawString(
            fontRendererObj,
            (new StringBuilder()).append("\2476HEALTH  \247f")
                .append(String.valueOf(hotdog.getHealth()))
                .append("\2473/\247f")
                .append(String.valueOf(hotdog.basehealth))
                .toString(),
            (width / 2 - 100) + k,
            height / 4 + 43 + byte0,
            0xff8d13);
        drawString(
            fontRendererObj,
            (new StringBuilder()).append("\2476EXPERIENCE  \247f")
                .append(String.valueOf(hotdog.totalexperience))
                .toString(),
            (width / 2 + 2 + k) - 10,
            height / 4 + 43 + byte0,
            0xff8d13);
        drawString(
            fontRendererObj,
            (new StringBuilder()).append("\2476ATTACK  \247f")
                .append(String.valueOf(hotdog.attackStrength))
                .toString(),
            (width / 2 - 100) + k,
            height / 4 + 58 + byte0,
            0xff8d13);
        drawString(
            fontRendererObj,
            (new StringBuilder()).append("\2476SPEED  \247f")
                .append(String.valueOf((int) (hotdog.baseSpeed * 100F) - 50))
                .toString(),
            (width / 2 + 2 + k) - 10,
            height / 4 + 58 + byte0,
            0xff8d13);
        drawCenteredString(
            ...
            (new StringBuilder()).append("\2473")
                .append(String.valueOf(CREEPSEntityHotdog.levelname[hotdog.level]))
                .toString(),
            width / 2 + 2 + k,
            height / 4 + 73 + byte0,
            0xff8d13);
        drawCenteredString(
            fontRendererObj,
            (new StringBuilder()).append("\2477ATTACK \2476[\247f")
                .append(String.valueOf(hotdog.skillattack))
                .append("\2476]  \2477DEFENSE \2476[\247f")
                .append(String.valueOf(hotdog.skilldefend))
                .append("\2476] \2477  HEALING \2476[\247f")
                .append(String.valueOf(hotdog.skillhealing))
                .append("\2476]  \2477SPEED \2476[\247f")
                .append(String.valueOf(hotdog.skillspeed))
                .append("\2476]")
                .toString(),
            width / 2 + 2 + k,
            height / 4 + 90 + byte0,

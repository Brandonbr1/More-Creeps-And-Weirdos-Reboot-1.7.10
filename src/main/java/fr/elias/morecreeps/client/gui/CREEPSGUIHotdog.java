...
public class CREEPSGUIHotdog extends GuiScreen {
  ...
  public void initGui() {
    ...
    buttonList.add(
        new GuiButton(
            2, width / 2 - 100, height / 4 + 108 + byte0, 98, 20, "\2476XX\247f FIGHT \2476XX"));
    buttonList.add(
        new GuiButton(
            3, width / 2 + 2, height / 4 + 108 + byte0, 98, 20, "\2476|| \247f STAY \2476||"));
    buttonList.add(
        new GuiButton(
            4, width / 2 - 100, height / 4 + 128 + byte0, 98, 20, "\2476<<\247f WANDER \2476>>"));
    buttonList.add(
        new GuiButton(
            5, width / 2 + 2, height / 4 + 128 + byte0, 98, 20, "\2476-[\247f TRAIN \2476]-"));
  ...
  public void drawScreen(int i, int j, float f) {
    ...
    drawCenteredString(
        fontRendererObj, "HOTDOG COMMAND CENTER", width / 2, height / 4 - 40, 0xffffff);
    namescreen.drawTextBox();
    fontRendererObj.drawStringWithShadow(
        (new StringBuilder())
            .append("\2476LEVEL  \247f")

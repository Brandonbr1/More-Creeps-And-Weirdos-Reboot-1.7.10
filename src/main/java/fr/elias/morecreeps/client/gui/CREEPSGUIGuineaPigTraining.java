...
public class CREEPSGUIGuineaPigTraining extends GuiScreen {
    ...
    public void initGui() {
        ...
        byte byte0 = -16;
        buttonList
            .add(new GuiButton(2, width / 2 - 110, height / 4 + 8 + byte0, 98, 20, "\2476<-\247f ATTACK \2476->"));
        buttonList
            .add(new GuiButton(3, width / 2 + 12, height / 4 + 8 + byte0, 98, 20, "\2476>> \247f DEFENSE \2476<<"));
        buttonList
            .add(new GuiButton(4, width / 2 - 110, height / 4 + 65 + byte0, 98, 20, "\2476++\247f HEALING \2476++"));
    ...
    protected void actionPerformed(GuiButton guibutton) {
        ...
        if (guibutton.id == 0) {
            Minecraft.getMinecraft()
                .displayGuiScreen(new CREEPSGUIGuineaPig(guineapig));
        }
        ...
        if (guibutton.id == 2 && guineapig.skillattack < 5) {
            ...
            if (checkWheat()) {
                ...
                double attackStrength = guineapig.getAttributeMap()
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        drawCenteredString(
            ...
            (new StringBuilder()).append("\2476")
                .append(String.valueOf(guineapig.name))
                .append("'s TRAINING")
                .toString(),
            width / 2,
            height / 4 - 40,
        ...
        drawCenteredString(
            fontRendererObj,
            (new StringBuilder()).append("\247fGUINEA PIG LEVEL : \2473")
        ...
        drawString(
            fontRendererObj,
            buildStat(guineapig.skillattack),
            (width / 2 - 107) + k,
            height / 4 + 38 + byte0,
            0xff8d13);
        drawString(
            fontRendererObj,
            buildStat(guineapig.skilldefend),
            width / 2 + 16 + k,
            height / 4 + 38 + byte0,
            0xff8d13);
        drawString(
            fontRendererObj,
            buildStat(guineapig.skillhealing),
            (width / 2 - 107) + k,
            height / 4 + 95 + byte0,
            0xff8d13);
        drawString(
            fontRendererObj,
            buildStat(guineapig.skillspeed),
            width / 2 + 16 + k,
            height / 4 + 95 + byte0,
            0xff8d13);
        EntityPlayerSP entityplayersp = Minecraft.getMinecraft().thePlayer;
        ...
        drawCenteredString(
            fontRendererObj,
            (new StringBuilder()).append("\247fWHEAT REMAINING: \2473")
        ...
        drawCenteredString(
            fontRendererObj,
            "\2476Each level costs five wheat",
            width / 2 + 2 + k,
            height / 4 + 140 + byte0,
            0xff8d13);

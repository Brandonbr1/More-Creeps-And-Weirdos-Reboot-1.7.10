...
public class CREEPSGUIGuineaPigTraining extends GuiScreen {
  ...
  public void initGui() {
    ...
    buttonList.add(
        new GuiButton(
            2, width / 2 - 110, height / 4 + 8 + byte0, 98, 20, "\2476<-\247f ATTACK \2476->"));
    buttonList.add(
        new GuiButton(
            3, width / 2 + 12, height / 4 + 8 + byte0, 98, 20, "\2476>> \247f DEFENSE \2476<<"));
    buttonList.add(
        new GuiButton(
            4, width / 2 - 110, height / 4 + 65 + byte0, 98, 20, "\2476++\247f HEALING \2476++"));
    buttonList.add(
        new GuiButton(
            5, width / 2 + 12, height / 4 + 65 + byte0, 98, 20, "\2476((\247f SPEED \2476))"));
  ...
  public void drawScreen(int i, int j, float f) {
    ...
    drawCenteredString(
        fontRendererObj,
        (new StringBuilder())
            .append("\247fGUINEA PIG LEVEL : \2473")
    ...
    drawCenteredString(
        fontRendererObj,
        (new StringBuilder())
            .append("\247fWHEAT REMAINING: \2473")

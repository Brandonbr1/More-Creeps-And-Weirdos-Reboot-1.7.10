...
public class CREEPSGUISneakySal extends GuiScreen {
  ...
  public void initGui() {
    ...
    this.buttonList.add(
        new GuiButton(
            ...
            "\2472    $\2476"
                + Math.round(
                    CREEPSEntitySneakySal.salprices[this.sneakysal.salslots[0]] * this.saleprice)
                + "\247f "
    ...
    this.buttonList.add(
        new GuiButton(
            ...
            "   \2472    $\2476"
                + Math.round(
                    CREEPSEntitySneakySal.salprices[this.sneakysal.salslots[1]] * this.saleprice)
                + "\247f "
    ...
    this.buttonList.add(
        new GuiButton(
            ...
            "\2472    $\2476"
                + Math.round(
                    CREEPSEntitySneakySal.salprices[this.sneakysal.salslots[2]] * this.saleprice)
                + "\247f "
    ...
    this.buttonList.add(
        new GuiButton(
            ...
            "\2472    $\2476"
                + Math.round(
                    CREEPSEntitySneakySal.salprices[this.sneakysal.salslots[3]] * this.saleprice)
                + "\247f "
    ...
    this.buttonList.add(
        new GuiButton(
            ...
            "\2472    $\2476"
                + Math.round(
                    CREEPSEntitySneakySal.salprices[this.sneakysal.salslots[4]] * this.saleprice)
                + "\247f "
    ...
    this.buttonList.add(
        new GuiButton(
            ...
            "\2472    $\2476"
                + Math.round(
                    CREEPSEntitySneakySal.salprices[this.sneakysal.salslots[5]] * this.saleprice)
                + "\247f "
    ...
    this.buttonList.add(
        new GuiButton(
            ...
            "\2472    $\2476"
                + Math.round(
                    CREEPSEntitySneakySal.salprices[this.sneakysal.salslots[6]] * this.saleprice)
                + "\247f "
    ...
    this.buttonList.add(
        new GuiButton(
            ...
            "\2472    $\2476"
                + Math.round(
                    CREEPSEntitySneakySal.salprices[this.sneakysal.salslots[7]] * this.saleprice)
                + "\247f "
    ...
    this.buttonList.add(
        new GuiButton(
            ...
            "\2472    $\2476"
                + Math.round(
                    CREEPSEntitySneakySal.salprices[this.sneakysal.salslots[8]] * this.saleprice)
                + "\247f "
    ...
    this.buttonList.add(
        new GuiButton(
            ...
            "\2472    $\2476"
                + Math.round(
                    CREEPSEntitySneakySal.salprices[this.sneakysal.salslots[9]] * this.saleprice)
                + "\247f "
                + CREEPSEntitySneakySal.saldescriptions[this.sneakysal.salslots[9]]));
    this.buttonList.add(
        new GuiButton(
            0, this.width / 2 - 100, this.height / 4 + 158 + byte0, 98, 20, "RIPOFF SAL"));
    this.buttonList.add(
        new GuiButton(1, this.width / 2 + 2, this.height / 4 + 158 + byte0, 98, 20, "DONE"));
  }
  ...
  public void drawScreen(int i, int j, float f) {
    ...
    this.drawCenteredString(
        this.fontRendererObj,
        (new StringBuilder())
            .append("\247eYour cash : \2472$\2476 ")

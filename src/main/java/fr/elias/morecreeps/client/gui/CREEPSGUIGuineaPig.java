...
public class CREEPSGUIGuineaPig extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton guibutton) {
        ...
        if (guibutton.id == 2) {
            ...
            guineapig.moveSpeed = guineapig.speedboost <= 0 ? guineapig.baseSpeed : guineapig.baseSpeed + 0.5F;
            mc.displayGuiScreen(null);
        }
        ...
        if (guibutton.id == 5) {
            Minecraft.getMinecraft()
                .displayGuiScreen(new CREEPSGUIGuineaPigTraining(guineapig));
        }
    }
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        drawString(
            ...
            (new StringBuilder()).append("\2476LEVEL  \247f")
                .append(String.valueOf(guineapig.level))
                .toString(),
            (width / 2 - 100) + k,
            height / 4 + 28 + byte0,
            0xff8d13);
        drawString(
            ...
            (new StringBuilder()).append("\2476NEXT LVL  \247f")
                .append(String.valueOf((int) guineapig.totaldamage))
                .append("\2473/\247f")
                .append(String.valueOf(CREEPSEntityGuineaPig.leveldamage[guineapig.level]))
                .toString(),
            width / 2 + 2 + k,
            height / 4 + 28 + byte0,
            0xff8d13);
        drawString(
            ...
            (new StringBuilder()).append("\2476HEALTH  \247f")
                .append(String.valueOf(guineapig.getHealth()))
                .append("\2473/\247f")
                .append(String.valueOf(guineapig.basehealth))
                .toString(),
            (width / 2 - 100) + k,
            height / 4 + 43 + byte0,
            0xff8d13);
        drawString(
            ...
            (new StringBuilder()).append("\2476EXPERIENCE  \247f")
                .append(String.valueOf(guineapig.totalexperience))
                .toString(),
            width / 2 + 2 + k,
            height / 4 + 43 + byte0,
            0xff8d13);
        ...
        drawString(
            ...
            (new StringBuilder()).append("\2476SPEED  \247f")
                .append(String.valueOf((int) (guineapig.baseSpeed * 100F) - 50))
                .toString(),
            width / 2 + 2 + k,
            height / 4 + 58 + byte0,
            0xff8d13);
        drawCenteredString(
            ...
            (new StringBuilder()).append("\2473")
                .append(String.valueOf(CREEPSEntityGuineaPig.levelname[guineapig.level]))
                .toString(),
            width / 2 + 2 + k,
            height / 4 + 78 + byte0,
            0xff8d13);

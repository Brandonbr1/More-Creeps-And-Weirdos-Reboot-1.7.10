...
public class CREEPSModelCaveman extends ModelBase {
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
    girlhair.rotateAngleY =
        flower.rotateAngleY =
            beard.rotateAngleY = bipedHead.rotateAngleY = f3 / (180F / (float) Math.PI);
    girlhair.rotateAngleX =
        flower.rotateAngleX =
            beard.rotateAngleX = bipedHead.rotateAngleX = f4 / (180F / (float) Math.PI);
    ...
    if (frozen < 1) {
      if (hammerswing != 0.0F) {
        club1.rotateAngleX =
            club2.rotateAngleX = club3.rotateAngleX = bipedRightArm.rotateAngleX = hammerswing;
      } else {
        club1.rotateAngleX =
            club2.rotateAngleX =
                club3.rotateAngleX =

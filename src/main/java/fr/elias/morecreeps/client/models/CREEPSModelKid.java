...
public class CREEPSModelKid extends ModelBase {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        stick.rotateAngleX = bipedRightArm.rotateAngleX = MathHelper.cos(f * 0.6662F + (float) Math.PI) * 2.0F
            * f1
            * 0.5F;
        lolly.rotateAngleX = bipedRightArm.rotateAngleX = MathHelper.cos(f * 0.6662F + (float) Math.PI) * 2.0F
            * f1
            * 0.5F;
        ...
        if (heldItemRight) {
            stick.rotateAngleX = bipedRightArm.rotateAngleX = bipedRightArm.rotateAngleX * 0.5F
                - ((float) Math.PI / 10F);
            lolly.rotateAngleX = bipedRightArm.rotateAngleX = bipedRightArm.rotateAngleX * 0.5F
                - ((float) Math.PI / 10F);
        }

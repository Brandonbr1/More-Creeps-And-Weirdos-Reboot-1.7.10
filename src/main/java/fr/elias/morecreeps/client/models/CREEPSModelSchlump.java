...
public class CREEPSModelSchlump extends ModelBase {
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
    ...
    nose.rotateAngleX =
        earL.rotateAngleX = earR.rotateAngleX = stash.rotateAngleX = head.rotateAngleX = 0.0F;
    nose.rotateAngleZ =
        earL.rotateAngleZ = earR.rotateAngleZ = stash.rotateAngleZ = head.rotateAngleZ = 0.0F;
    nose.rotateAngleX =
        earL.rotateAngleX =
            earR.rotateAngleX =
                stash.rotateAngleX = head.rotateAngleX += MathHelper.sin(f2 * 0.067F) * 0.05F;
    nose.rotateAngleZ =
        earL.rotateAngleZ =
            earR.rotateAngleZ =
                stash.rotateAngleZ =
                    head.rotateAngleZ += MathHelper.cos(f2 * 0.09F) * 0.05F + 0.05F;
    neck2.rotateAngleX = 0.0F;
    head2.rotateAngleX = 0.0F;

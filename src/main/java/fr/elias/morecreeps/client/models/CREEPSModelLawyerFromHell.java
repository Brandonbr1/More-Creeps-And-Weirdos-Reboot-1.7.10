...
public class CREEPSModelLawyerFromHell extends ModelBase {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.case2.rotateAngleX = this.casehandle.rotateAngleX = this.leftarm.rotateAngleX = MathHelper.cos(f * 0.6662F) * 2.0F
                * f1
                * 0.5F;
        ...
        this.watch1.rotateAngleZ = this.watch2.rotateAngleZ = this.rightarm.rotateAngleZ += MathHelper.cos(f2 * 0.09F) * 0.05F + 0.05F;
        this.case2.rotateAngleZ = this.casehandle.rotateAngleZ = this.leftarm.rotateAngleZ -= MathHelper.cos(f2 * 0.09F) * 0.05F
                + 0.05F;
        this.watch1.rotateAngleX = this.watch2.rotateAngleX = this.rightarm.rotateAngleX += MathHelper.sin(f2 * 0.067F) * 0.05F;
        this.case2.rotateAngleX = this.casehandle.rotateAngleX = this.leftarm.rotateAngleX -= MathHelper.sin(f2 * 0.067F) * 0.05F;
    }
}

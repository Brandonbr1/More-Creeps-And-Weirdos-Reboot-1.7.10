...
public class CREEPSModelRatMan extends ModelBase {
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
    wiskers.rotateAngleY =
        snout.rotateAngleY =
            nose.rotateAngleY =
                earR.rotateAngleY =
                    earL.rotateAngleY = ratHead.rotateAngleY = f3 / (180F / (float) Math.PI);
    wiskers.rotateAngleX =
        snout.rotateAngleX =
            nose.rotateAngleX =
                earR.rotateAngleX = earL.rotateAngleX = ratHead.rotateAngleX = f4 / 77.29578F;

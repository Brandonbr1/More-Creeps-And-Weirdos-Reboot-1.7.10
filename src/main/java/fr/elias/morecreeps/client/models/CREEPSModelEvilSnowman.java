...
public class CREEPSModelEvilSnowman extends ModelBase {
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
    ...
    hat.rotateAngleY =
        hatbrim.rotateAngleY =
            nose.rotateAngleY = eyeL.rotateAngleY = eyeR.rotateAngleY = head.rotateAngleY;
    hat.rotateAngleX =
        hatbrim.rotateAngleX =
            nose.rotateAngleX = eyeL.rotateAngleX = eyeR.rotateAngleX = head.rotateAngleX;
    arm1R.rotateAngleZ =
        MathHelper.cos(f * 0.6662F + (float) Math.PI) * 3F * f1 * 0.5F + 0.3F + 0.49723F;
    arm2R.rotateAngleZ =
        (MathHelper.cos(f * 0.6662F + (float) Math.PI) * 3F * f1 * 0.5F + 0.3F) - 0.40682F;

...
public class CREEPSModelHotdog extends ModelBase {
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
    ...
    strapL.rotateAngleY =
        strapR.rotateAngleY =
            helmet.rotateAngleY = snout.rotateAngleY = nose.rotateAngleY = headDog.rotateAngleY;
    strapL.rotateAngleX =
        strapR.rotateAngleX = snout.rotateAngleX = nose.rotateAngleX = headDog.rotateAngleX;

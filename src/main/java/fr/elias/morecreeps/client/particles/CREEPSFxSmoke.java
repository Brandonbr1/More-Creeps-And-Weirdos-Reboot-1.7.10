...
public class CREEPSFxSmoke extends EntityFX {
    ...
    public CREEPSFxSmoke(World world, double d, double d1, double d2, float f, float particleGravity) {
    ...
    public void renderParticle(Tessellator p_70539_1_, float p_70539_2_, float p_70539_3_, float p_70539_4_,
        ...
        float f11 = (float) (this.prevPosX + (this.posX - this.prevPosX) * (double) p_70539_3_ - interpPosX);
        float f12 = (float) (this.prevPosY + (this.posY - this.prevPosY) * (double) p_70539_3_ - interpPosY);
        float f13 = (float) (this.prevPosZ + (this.posZ - this.prevPosZ) * (double) p_70539_3_ - interpPosZ);

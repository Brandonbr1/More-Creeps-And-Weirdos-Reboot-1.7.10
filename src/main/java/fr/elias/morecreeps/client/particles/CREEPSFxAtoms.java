...
public class CREEPSFxAtoms extends EntityFX {
  ...
  public CREEPSFxAtoms(World world, double d, double d1, double d2, Item item, float f) {
    ...
    // this.particleIcon =
    // Minecraft.getMinecraft().getRenderItem().getItemModelMesher().getParticleIcon(item);
    setSize(0.4F, 0.4F);
    particleRed = 1.0F;
    particleBlue = 1.0F;
    particleGreen = 1.0F;
  ...
  public void func_180434_a(
    ...
    // super.func_180434_a(p_180434_9_, p_180434_2_, p_180434_3_, p_180434_4_, p_180434_5_,
    // p_180434_6_,
    ...
    float f11 =
        (float) (this.prevPosX + (this.posX - this.prevPosX) * (double) p_180434_3_ - interpPosX);
    float f12 =
        (float) (this.prevPosY + (this.posY - this.prevPosY) * (double) p_180434_3_ - interpPosY);
    float f13 =
        (float) (this.prevPosZ + (this.posZ - this.prevPosZ) * (double) p_180434_3_ - interpPosZ);
    p_180434_1_.setColorRGBA_F(
